...
const UI_TRANSLATIONS = {
  ...
  "Catalan": {
    gakuSelfStudy: "GAKU AUTOAPRENENTATGE",
    studyPlan: "Pla d'estudi",
    help: "🆘 Ajuda",
    editProfile: "✏️ Edita el perfil",
    weeklyProgress: "Progrés setmanal",
    tabSchedule: "📅 Horari",
    tabPractice: "🎯 Pràctica",
    tabVocabulary: "📚 Vocabulari",
    tabResources: "🔗 Recursos",
    tabMilestones: "🏆 Fites",
    yourWeeklySchedule: "📅 EL TEU HORARI D'ESTUDI SETMANAL",
    ...
    vocabReview: "Repàs de vocabulari — Anki o paraules desades (10 min)",
    speakAloud: "En veu alta: resumeix el contingut d'avui en japonès (5 min)",
    taskConversation: "Joc de rols o shadowing — nucli del CLT",
    taskListening: "NHK World o JapanesePod101",
    taskReading: "Lector graduat Tadoku o NHK Web Easy",
    taskGrammar: "Imabi + escriu 3 frases d'exemple",
    taskKanji: "Nihonten AI — 5 kanjis nous en context",
    taskJlpt: "Japanese Test 4 You — una secció de pràctica",
    taskPronunciation: "Targetes d'àudio Anki — fes shadow de 20 paraules",
    recommendedForLevel: "⭐ Recomanat per al teu nivell",
    curatedFor: "Seleccionat per al nivell",
    yourResources: "🔗 ELS TEUS RECURSOS",
    curatedForLevel: "Seleccionat per al nivell",
    skills: "habilitats:",
    openResource: "Obre",
    noResources: "No hi ha recursos. Edita el teu perfil i selecciona les habilitats d'estudi.",
    free: "GRATUÏT", paid: "DE PAGAMENT",
    vocab: "Vocabulari", grammar: "Gramàtica", reading: "Lectura", speaking: "Expressió oral", listening: "Comprensió oral",
    yourGoalRoadmap: "🏆 EL TEU FULL DE RUTA D'OBJECTIUS",
    levelToGoal: "Nivell",
    goal: "Objectiu",
    youveGotThis: "Tu pots!",
    motivationText: "Cada conversa, cada frase, cada paraula t'apropa. El CLT tracta de la comunicació real — i ja ho estàs fent. 頑張ってください！",
    bookLesson: "Reserva una classe de prova GRATUÏTA amb GAKU →",
    helpTitle: "🆘 AJUDA",
    whatWouldYouLike: "Què vols fer?",
    customizedLesson: "📋 Lliçó personalitzada per avui",
    howToUse: "❓ Com utilitzar aquesta aplicació",
    back: "← Enrere",
    howAreYouFeeling: "Com et sents avui?",
    mood: "ESTAT D'ÀNIM", moodPlaceholder: "Selecciona...",
    moodMotivated: "😤 Motivat/da i amb energia",
    moodOkay: "😐 Bé, dia normal",
    moodTired: "😴 Cansat/da i amb poca energia",
    moodStressed: "😰 Estressat/da o ansiós/osa",
    moodHappy: "😊 Feliç i relaxat/da",
    availableTime: "TEMPS DISPONIBLE",
    energyLevel: "NIVELL D'ENERGIA",
    energyHigh: "🔥 Alt — preparat per als reptes",
    energyMedium: "⚡ Mitjà — estudi normal",
    energyLow: "🌙 Baix — només repàs lleuger",
    wantsDifferent: "Avui vull fer una cosa diferent",
    differentPlaceholder: "Digues-nos què vols fer avui...",
    getTodaysPlan: "Obtén el pla d'avui ✨",
    generating: "Generant...",
    tryAgain: "Torna-ho a provar",
    select: "Selecciona...",
    tenMin: "10 minuts", twentyMin: "20 minuts", thirtyMin: "30 minuts",
    oneHour: "1 hora", oneHalfHour: "1,5 hores+",
    formTitle: "El teu perfil d'aprenentatge",
    formEditTitle: "Edita el teu perfil d'aprenentatge",
    formSubtitle: "Parla'ns de tu per crear el teu pla d'estudi CLT personalitzat",
    formEditSubtitle: "Actualitza els detalls a continuació — les teves respostes existents es mantenen fins que les canviïs.",
    backToMyPlan: "← Torna al meu pla",
    yourName: "EL TEU NOM *",
    namePlaceholder: "p. ex. Tanaka Yuki",
    email: "CORREU ELECTRÒNIC *",
    emailPlaceholder: "tu@email.com",
    country: "PAÍS *",
    countryPlaceholder: "p. ex. Catalunya, Espanya...",
    yourNativeLanguage: "LA TEVA LLENGUA MATERNA",
    finalGoal: "OBJECTIU FINAL *",
    selectGoal: "Selecciona el teu objectiu",
    goalN5: "Aprovar el JLPT N5", goalN4: "Aprovar el JLPT N4", goalN3: "Aprovar el JLPT N3",
    goalN2: "Aprovar el JLPT N2", goalN1: "Aprovar el JLPT N1",
    goalJob: "Trobar feina al Japó", goalTravel: "Viatjar al Japó",
    goalStudyAbroad: "Estudiar al Japó", goalConversation: "Conversa diària",
    goalOther: "Altres",
    whatDoYouWantToStudy: "QUÈ VOLS ESTUDIAR?",
    customGoalPlaceholder: "Digues-nos què vols estudiar o aconseguir...",
    whenAchieve: "QUAN VOLS ACONSEGUIR-HO? *",
    selectTimeline: "Selecciona el termini",
    lessThan6: "Menys de 6 mesos", within1: "En 1 any",
    twoThreeYears: "2–3 anys", over3: "Més de 3 anys",
    currentJlpt: "NIVELL JLPT ACTUAL *",
    autoFilled: "Emplenat automàticament des de la teva prova",
    changeLevel: "Si vols canviar el teu nivell, selecciona'l a continuació.",
    selectLevel: "Selecciona el nivell",
    beginner: "Principiant",
    studyTimePerDay: "TEMPS D'ESTUDI DIARI *",
    selectHours: "Selecciona les hores",
    lessThan1h: "Menys d'1 hora", oneTwo: "1–2 hores",
    twoThree: "2–3 hores", threePlus: "3+ hores",
    daysPerWeek: "DIES PER SETMANA *",
    selectDays: "Selecciona els dies",
    oneTwoDays: "1–2 dies", threeFourDays: "3–4 dies",
    fiveSixDays: "5–6 dies", everyDay: "Cada dia",
    whatStudySkills: "QUÈ VOLS ESTUDIAR? * (selecciona totes les que apliquin)",
    writingNote: "✍️ La pràctica d'escriptura està disponible a la pestanya Escriptura per a tots els usuaris",
    saveChanges: "Desa els canvis →",
    buildPlan: "Crea el meu pla d'estudi →",
    fillRequired: "Si us plau, omple tots els camps obligatoris (*) i selecciona almenys una habilitat.",
    skillPronunciation: "🔊 Pronunciació", skillListening: "👂 Comprensió oral",
    skillConversation: "💬 Conversa", skillJlpt: "🎯 Preparació JLPT",
    skillReading: "📖 Lectura", skillKanji: "🈳 Kanji", skillGrammar: "📝 Gramàtica",
    howToTitle: "Com utilitzar aquesta aplicació",
    howToSchedule: "El teu pla d'estudi setmanal, dividit en tasques diàries. Toca una tasca per marcar-la com a completada.",
    howToPractice: "Exercicis generats per IA basats en les habilitats que has triat al teu perfil. Toca 'Mostra la resposta' per comprovar-ho.",
    howToVocab: "Cerca qualsevol tema per obtenir paraules adequades al teu nivell amb frases d'exemple. Desa les paraules que vulguis recordar.",
    howToResources: "Eines gratuïtes (i algunes de pagament) que coincideixen amb les habilitats que has seleccionat.",
    howToMilestones: "El teu full de ruta cap al teu objectiu. Toca cada fita quan la completis.",
    howToEditProfile: "Actualitza els teus objectius, nivell, horari o habilitats en qualsevol moment.",
    howToHelp: "Obtén un pla personalitzat per a avui basat en el teu estat d'ànim, temps i energia.",
  },
};
...
const LANGUAGES = [
  ...
  "Japanese","Turkish","Nepali","Catalan",
];
