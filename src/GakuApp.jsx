...
const UI_TRANSLATIONS = {
  "English": {
    ...
    tutorialScheduleDesc: "This is your personalized weekly study plan. Try checking off one task below — then watch your progress bar fill up.",
    tutorialVocabularyDesc: "Try it now: search for a word (e.g. 食べる) and save it to your own deck. You can review saved words anytime with flashcards.",
    ...
    feedbackChecking: "Checking...",
    feedbackAlreadySubmitted: "You've already submitted your one-time feedback. Thank you! (GAKU-invited students can submit as many times as they like.)",
    feedbackSuccess: "Thank you — your feedback was sent.",
    feedbackPlaceholder: "What would you like us to improve, or what's on your mind?",
    feedbackRejected: "This message couldn't be accepted. Please rephrase without personal insults, harassment, or discriminatory language.",
    feedbackError: "Something went wrong sending your feedback. Please try again.",
    ...
    jlptFormTitle: "JLPT Free Assessment Report — APPLY NOW",
    jlptQuestionLevel: "Which JLPT do you want to take?",
    jlptQuestionMode: "How do you prefer to take it?",
    jlptModeSelf: "By myself",
    jlptModeTrial: "Take one as a Free Trial Lesson",
    jlptQuestionSection: "Which part of JLPT do you want to do?",
    jlptSectionLanguage: "Language knowledge (Vocabulary/Grammar)",
    jlptSectionReading: "Reading",
    jlptSectionListening: "Listening",
    jlptSectionAll: "All",
    jlptSubmit: "Submit",
    ...
    freePlanGakuStudentHint: "GAKU lesson students get the app included free. No code? Book a lesson to become one →",
    ...
    pronAddNewLabel: "Add a word or sentence",
    pronAddNewPlaceholder: "Type or paste a Japanese word or sentence...",
    pronAddBtn: "Add word/sentence",
    pronBreakBtn: "🔍 Break into the phrase",
    pronBreaking: "Breaking down...",
    pronBreakFailed: "Couldn't break that down. Try again.",
    speed08: "🐢 0.8x",
    speed05: "🐌 0.5x",
  ...
  "French": {
    ...
    tutorialScheduleDesc: "Voici votre planning d'étude hebdomadaire personnalisé. Essayez de cocher une tâche ci-dessous — puis regardez votre barre de progression avancer.",
    tutorialVocabularyDesc: "Essayez maintenant : recherchez un mot (par ex. 食べる) et enregistrez-le dans votre propre deck. Vous pourrez réviser les mots enregistrés à tout moment avec des flashcards.",
    ...
    feedbackChecking: "Vérification...",
    feedbackAlreadySubmitted: "Vous avez déjà envoyé votre unique retour. Merci ! (Les étudiants invités par GAKU peuvent en envoyer autant de fois qu'ils le souhaitent.)",
    feedbackSuccess: "Merci — votre retour a été envoyé.",
    feedbackPlaceholder: "Qu'aimeriez-vous que nous améliorions, ou qu'avez-vous en tête ?",
    feedbackRejected: "Ce message n'a pas pu être accepté. Merci de le reformuler sans insultes personnelles, harcèlement ni propos discriminatoires.",
    feedbackError: "Une erreur s'est produite lors de l'envoi de votre retour. Veuillez réessayer.",
    ...
    jlptFormTitle: "Rapport d'évaluation JLPT gratuit — POSTULER MAINTENANT",
    jlptQuestionLevel: "Quel niveau du JLPT souhaitez-vous passer ?",
    jlptQuestionMode: "Comment préférez-vous le passer ?",
    jlptModeSelf: "Par moi-même",
    jlptModeTrial: "Le passer dans le cadre d'un cours d'essai gratuit",
    jlptQuestionSection: "Quelle partie du JLPT souhaitez-vous faire ?",
    jlptSectionLanguage: "Connaissances linguistiques (Vocabulaire/Grammaire)",
    jlptSectionReading: "Lecture",
    jlptSectionListening: "Écoute",
    jlptSectionAll: "Tout",
    jlptSubmit: "Envoyer",
    ...
    pronGenerateBtn: "Créer la pratique de prononciation",
    pronNoItems: "Aucune phrase de taille adaptée n'a été trouvée dans ce contenu. Essayez de coller plus de texte.",
    pronReadMode: "👀 Lire",
    pronListenMode: "👂 Écouter",
    pronRevealText: "Afficher le texte",
    pronHideTextBtn: "Masquer le texte",
    pronListenFirst: "Appuyez sur Écouter, puis essayez de répéter.",
    pronRecordPrompt: "Maintenant, dites-le à voix haute",
    pronCorrect: "Correct ! 🎉",
    pronYourAttempt: "Vous avez dit :",
    pronTargetLabel: "Cible :",
    pronTryAgain: "Réessayer",
    pronAddNewLabel: "Ajouter un mot ou une phrase",
    pronAddNewPlaceholder: "Tapez ou collez un mot ou une phrase en japonais...",
    pronAddBtn: "Ajouter un mot/une phrase",
    pronBreakBtn: "🔍 Décomposer la phrase",
    pronBreaking: "Décomposition en cours...",
    pronBreakFailed: "Impossible de décomposer cela. Réessayez.",
    speed08: "🐢 0,8x",
    speed05: "🐌 0,5x",
    ...
    freePlanGakuStudentHint: "Les élèves qui prennent des cours GAKU ont l'application incluse gratuitement. Pas de code ? Réservez un cours pour le devenir →",
    ...
    wantToJoinGaku: "Vous voulez rejoindre GAKU ?",
    checkLater: "Vérifier plus tard",
    studyPlanReadyTitle: "Votre plan d'étude est prêt !",
    studyPlanReadyDesc: "Débloquez votre emploi du temps hebdomadaire personnalisé, vos exercices et vos outils de vocabulaire.",
    appOnlyLabel: "📱 APPLICATION SEULE",
    monthlyLabel: "MENSUEL",
    perMonth: "/ mois",
    threeMonthsSave5: "3 MOIS · Économisez 5 %",
    sixMonthsSave10: "6 MOIS · Économisez 10 % ⭐",
    appLessonsLabel: "🎓 APPLICATION + COURS · 50 % de réduction sur les cours",
    threeMonthsSave5_30min: "3 MOIS · Économisez 5 % · 30 min/mois",
    threeMonthsSave5_1hr: "3 MOIS · Économisez 5 % · 1h/mois",
    sixMonthsSave5_30min: "6 MOIS · Économisez 5 % · 30 min/mois ⭐",
    sixMonthsSave10_1hr: "6 MOIS · Économisez 10 % · 1h/mois ⭐ Meilleure offre",
    loginTitle: "Connexion",
    signupTitle: "Créer votre compte",
    passwordPlaceholder: "Mot de passe",
    invitationCodeOptional: "Code d'invitation GAKU (facultatif)",
    loginButton: "Connexion",
    signupButton: "S'inscrire",
    needAccount: "Besoin d'un compte ? Inscrivez-vous",
    haveAccount: "Vous avez déjà un compte ? Connectez-vous",
    deviceApprovalTitle: "Nouvel appareil détecté",
    deviceApprovalDesc: "Nous avons envoyé un e-mail d'approbation à vous et à GAKU. Une fois les deux approbations reçues, cet appareil sera débloqué — veuillez vérifier votre boîte de réception.",
    convOrDivider: "OU",
    convDescLive: "Jouez une vidéo YouTube avec le son près de votre micro. GAKU écoute le dialogue réel et, ligne par ligne, vous aide à le comprendre et vous suggère comment répondre.",
    convHeardTitle: "Ce que GAKU a entendu",
    convClearBtn: "🗑 Effacer",
    convHintBtn: "Comment répondriez-vous ? (4 choix)",
    convHintLoading: "Recherche de suggestions de réponse...",
    convTryAgain: "↺ Réessayer",
    convListenTitle: "Suivre une vidéo en écoutant",
    convListenDesc: "Jouez une vidéo YouTube avec le son près de votre micro. GAKU écoutera et construira la transcription ci-dessus pour vous — puis appuyez sur \"Créer un exercice de conversation\" comme d'habitude.",
    convListenStart: "Commencer l'écoute",
    convListenStop: "Arrêter l'écoute",
    convListening: "Écoute en cours…",
    convListenUnsupported: "L'écoute en direct n'est pas prise en charge par ce navigateur — essayez Chrome sur ordinateur ou Android.",
    saveWord: "Enregistrer le mot",
    saveTitle: "Enregistrer",
    saveToYourVocab: "Ajouter à votre vocabulaire",
    saveToYourVocabSub: "Votre liste de vocabulaire par défaut",
    saveAddToFolder: "Ajouter à un dossier",
    saveAddToFolderSub: "Choisissez un dossier existant",
    saveCreateFolder: "Créer un nouveau dossier",
    saveCreateFolderSub: "Créez un nouveau dossier pour ce mot",
    saveCancel: "Annuler",
    saveChooseFolder: "Choisissez un dossier",
    saveNoFolders: "Aucun dossier personnalisé pour le moment — créez-en un d'abord !",
    saveTo: "Enregistrer dans",
    saveCreateAndSave: "Créer et enregistrer",
    saveFolderPlaceholder: "Nom du dossier (ex. かおりさん 授業)",
    saveBack: "← Retour",
},
  ...
  "Spanish": {
    ...
    tutorialScheduleDesc: "Este es tu plan de estudio semanal personalizado. Marca una tarea de abajo y observa cómo avanza tu barra de progreso.",
    tutorialVocabularyDesc: "Pruébalo ahora: busca una palabra (por ejemplo, 食べる) y guárdala en tu propio mazo. Podrás repasar las palabras guardadas cuando quieras con tarjetas de memoria.",
    ...
    feedbackChecking: "Comprobando...",
    feedbackAlreadySubmitted: "Ya has enviado tu comentario único. ¡Gracias! (Los estudiantes invitados por GAKU pueden enviar tantas veces como quieran.)",
    feedbackSuccess: "Gracias — tu comentario fue enviado.",
    feedbackPlaceholder: "¿Qué te gustaría que mejoráramos, o qué tienes en mente?",
    feedbackRejected: "Este mensaje no pudo ser aceptado. Por favor, reformúlalo sin insultos personales, acoso ni lenguaje discriminatorio.",
    feedbackError: "Ocurrió un error al enviar tu comentario. Por favor, inténtalo de nuevo.",
    ...
    jlptFormTitle: "Informe de evaluación gratuita del JLPT — POSTULAR AHORA",
    jlptQuestionLevel: "¿Qué nivel del JLPT quieres presentar?",
    jlptQuestionMode: "¿Cómo prefieres tomarlo?",
    jlptModeSelf: "Por mi cuenta",
    jlptModeTrial: "Tomarlo como una lección de prueba gratuita",
    jlptQuestionSection: "¿Qué parte del JLPT quieres hacer?",
    jlptSectionLanguage: "Conocimiento del idioma (Vocabulario/Gramática)",
    jlptSectionReading: "Lectura",
    jlptSectionListening: "Comprensión auditiva",
    jlptSectionAll: "Todo",
    jlptSubmit: "Enviar",
    ...
    pronGenerateBtn: "Crear práctica de pronunciación",
    pronNoItems: "No se encontraron oraciones del tamaño adecuado en ese contenido. Intenta pegar más texto.",
    pronReadMode: "👀 Leer",
    pronListenMode: "👂 Escuchar",
    pronRevealText: "Mostrar texto",
    pronHideTextBtn: "Ocultar texto",
    pronListenFirst: "Toca Escuchar y luego intenta repetirlo.",
    pronRecordPrompt: "Ahora dilo en voz alta",
    pronCorrect: "¡Correcto! 🎉",
    pronYourAttempt: "Dijiste:",
    pronTargetLabel: "Objetivo:",
    pronTryAgain: "Intentar de nuevo",
    pronAddNewLabel: "Agregar una palabra u oración",
    pronAddNewPlaceholder: "Escribe o pega una palabra u oración en japonés...",
    pronAddBtn: "Agregar palabra/oración",
    pronBreakBtn: "🔍 Dividir la frase",
    pronBreaking: "Dividiendo...",
    pronBreakFailed: "No se pudo dividir. Inténtalo de nuevo.",
    speed08: "🐢 0.8x",
    speed05: "🐌 0.5x",
    ...
    freePlanGakuStudentHint: "Los alumnos con clases GAKU reciben la app gratis. ¿Sin código? Reserva una clase para serlo →",
    ...
    wantToJoinGaku: "¿Quieres unirte a GAKU?",
    checkLater: "Volver a comprobar más tarde",
    studyPlanReadyTitle: "¡Tu plan de estudio está listo!",
    studyPlanReadyDesc: "Desbloquea tu horario semanal personalizado, ejercicios de práctica y herramientas de vocabulario.",
    appOnlyLabel: "📱 SOLO APP",
    monthlyLabel: "MENSUAL",
    perMonth: "/ mes",
    threeMonthsSave5: "3 MESES · Ahorra 5 %",
    sixMonthsSave10: "6 MESES · Ahorra 10 % ⭐",
    appLessonsLabel: "🎓 APP + CLASES · 50 % de descuento en clases",
    threeMonthsSave5_30min: "3 MESES · Ahorra 5 % · 30 min/mes",
    threeMonthsSave5_1hr: "3 MESES · Ahorra 5 % · 1h/mes",
    sixMonthsSave5_30min: "6 MESES · Ahorra 5 % · 30 min/mes ⭐",
    sixMonthsSave10_1hr: "6 MESES · Ahorra 10 % · 1h/mes ⭐ Mejor oferta",
    loginTitle: "Iniciar sesión",
    signupTitle: "Crea tu cuenta",
    passwordPlaceholder: "Contraseña",
    invitationCodeOptional: "Código de invitación de GAKU (opcional)",
    loginButton: "Iniciar sesión",
    signupButton: "Registrarse",
    needAccount: "¿Necesitas una cuenta? Regístrate",
    haveAccount: "¿Ya tienes una cuenta? Inicia sesión",
    deviceApprovalTitle: "Nuevo dispositivo detectado",
    deviceApprovalDesc: "Hemos enviado un correo de aprobación a ti y a GAKU. Una vez que ambos aprueben, este dispositivo quedará desbloqueado — revisa tu bandeja de entrada.",
    convOrDivider: "O",
    convDescLive: "Reproduce un video de YouTube con el sonido cerca de tu micrófono. GAKU escucha el diálogo real y, línea por línea, te ayuda a entenderlo y te sugiere cómo responder.",
    convHeardTitle: "Lo que GAKU escuchó",
    convClearBtn: "🗑 Borrar",
    convHintBtn: "¿Cómo responderías? (4 opciones)",
    convHintLoading: "Pensando sugerencias de respuesta...",
    convTryAgain: "↺ Intentar de nuevo",
    convListenTitle: "Escuchar junto con un video",
    convListenDesc: "Reproduce un video de YouTube con el sonido cerca de tu micrófono. GAKU escuchará y creará la transcripción de arriba por ti — luego toca \"Crear ejercicio de conversación\" como de costumbre.",
    convListenStart: "Empezar a escuchar",
    convListenStop: "Dejar de escuchar",
    convListening: "Escuchando…",
    convListenUnsupported: "La escucha en vivo no es compatible con este navegador — prueba Chrome en escritorio o Android.",
    saveWord: "Guardar palabra",
    saveTitle: "Guardar",
    saveToYourVocab: "Añadir a tu vocabulario",
    saveToYourVocabSub: "Tu lista de vocabulario predeterminada",
    saveAddToFolder: "Añadir a carpeta",
    saveAddToFolderSub: "Elige una carpeta existente",
    saveCreateFolder: "Crear nueva carpeta",
    saveCreateFolderSub: "Crea una nueva carpeta para esta palabra",
    saveCancel: "Cancelar",
    saveChooseFolder: "Elige una carpeta",
    saveNoFolders: "Aún no hay carpetas personalizadas — ¡crea una primero!",
    saveTo: "Guardar en",
    saveCreateAndSave: "Crear y guardar",
    saveFolderPlaceholder: "Nombre de la carpeta (ej. かおりさん 授業)",
    saveBack: "← Atrás",
},
  ...
  "Portuguese": {
    ...
    tutorialScheduleDesc: "Este é o seu plano de estudos semanal personalizado. Marque uma tarefa abaixo e veja sua barra de progresso avançar.",
    tutorialVocabularyDesc: "Experimente agora: pesquise uma palavra (por exemplo, 食べる) e salve-a no seu próprio baralho. Você poderá revisar as palavras salvas a qualquer momento com flashcards.",
    ...
    feedbackChecking: "Verificando...",
    feedbackAlreadySubmitted: "Você já enviou seu feedback único. Obrigado! (Alunos convidados pela GAKU podem enviar quantas vezes quiserem.)",
    feedbackSuccess: "Obrigado — seu feedback foi enviado.",
    feedbackPlaceholder: "O que você gostaria que melhorássemos, ou o que está pensando?",
    feedbackRejected: "Esta mensagem não pôde ser aceita. Por favor, reformule sem insultos pessoais, assédio ou linguagem discriminatória.",
    feedbackError: "Algo deu errado ao enviar seu feedback. Por favor, tente novamente.",
    feedbackSubmitting: "Enviando...",
    ...
    jlptFormTitle: "Relatório de Avaliação Gratuita do JLPT — INSCREVA-SE AGORA",
    jlptQuestionLevel: "Qual nível do JLPT você quer fazer?",
    jlptQuestionMode: "Como você prefere fazê-lo?",
    jlptModeSelf: "Por conta própria",
    jlptModeTrial: "Fazer como parte de uma aula experimental gratuita",
    jlptQuestionSection: "Qual parte do JLPT você quer fazer?",
    jlptSectionLanguage: "Conhecimento de idioma (Vocabulário/Gramática)",
    jlptSectionReading: "Leitura",
    jlptSectionListening: "Compreensão auditiva",
    jlptSectionAll: "Tudo",
    jlptSubmit: "Enviar",
    jlptSubmitting: "Enviando…",
    jlptBack: "Voltar",
    ...
    pronGenerateBtn: "Criar prática de pronúncia",
    pronNoItems: "Não foram encontradas frases de tamanho adequado nesse conteúdo. Tente colar mais texto.",
    pronReadMode: "👀 Ler",
    pronListenMode: "👂 Ouvir",
    pronRevealText: "Mostrar texto",
    pronHideTextBtn: "Ocultar texto",
    pronListenFirst: "Toque em Ouvir e depois tente repetir.",
    pronRecordPrompt: "Agora diga em voz alta",
    pronCorrect: "Correto! 🎉",
    pronYourAttempt: "Você disse:",
    pronTargetLabel: "Alvo:",
    pronTryAgain: "Tentar novamente",
    pronAddNewLabel: "Adicionar uma palavra ou frase",
    pronAddNewPlaceholder: "Digite ou cole uma palavra ou frase em japonês...",
    pronAddBtn: "Adicionar palavra/frase",
    pronBreakBtn: "🔍 Dividir a frase",
    pronBreaking: "Dividindo...",
    pronBreakFailed: "Não foi possível dividir. Tente novamente.",
    speed08: "🐢 0,8x",
    speed05: "🐌 0,5x",
    ...
    freePlanGakuStudentHint: "Alunos com aulas GAKU recebem o app incluso e grátis. Sem código? Agende uma aula para se tornar um →",
    ...
    wantToJoinGaku: "Quer entrar na GAKU?",
    checkLater: "Verificar novamente mais tarde",
    studyPlanReadyTitle: "Seu plano de estudos está pronto!",
    studyPlanReadyDesc: "Desbloqueie seu cronograma semanal personalizado, exercícios práticos e ferramentas de vocabulário.",
    appOnlyLabel: "📱 SOMENTE APP",
    monthlyLabel: "MENSAL",
    perMonth: "/ mês",
    threeMonthsSave5: "3 MESES · Economize 5%",
    sixMonthsSave10: "6 MESES · Economize 10% ⭐",
    appLessonsLabel: "🎓 APP + AULAS · 50% de desconto nas aulas",
    threeMonthsSave5_30min: "3 MESES · Economize 5% · 30min/mês",
    threeMonthsSave5_1hr: "3 MESES · Economize 5% · 1h/mês",
    sixMonthsSave5_30min: "6 MESES · Economize 5% · 30min/mês ⭐",
    sixMonthsSave10_1hr: "6 MESES · Economize 10% · 1h/mês ⭐ Melhor oferta",
    loginTitle: "Entrar",
    signupTitle: "Crie sua conta",
    passwordPlaceholder: "Senha",
    invitationCodeOptional: "Código de convite GAKU (opcional)",
    loginButton: "Entrar",
    signupButton: "Cadastrar",
    needAccount: "Precisa de uma conta? Cadastre-se",
    haveAccount: "Já tem uma conta? Entrar",
    deviceApprovalTitle: "Novo dispositivo detectado",
    deviceApprovalDesc: "Enviamos um e-mail de aprovação para você e para a GAKU. Assim que ambos aprovarem, este dispositivo será desbloqueado — verifique sua caixa de entrada.",
    convOrDivider: "OU",
    convDescLive: "Reproduza um vídeo do YouTube com o som próximo ao microfone. O GAKU escuta o diálogo real e, linha por linha, ajuda você a entendê-lo e sugere como responder.",
    convHeardTitle: "O que o GAKU ouviu",
    convClearBtn: "🗑 Limpar",
    convHintBtn: "Como você responderia? (4 opções)",
    convHintLoading: "Pensando em sugestões de resposta...",
    convTryAgain: "↺ Tentar novamente",
    convListenTitle: "Ouvir junto com um vídeo",
    convListenDesc: "Reproduza um vídeo do YouTube com o som próximo ao microfone. O GAKU vai escutar e montar a transcrição acima para você — depois toque em \"Criar exercício de conversação\" normalmente.",
    convListenStart: "Começar a ouvir",
    convListenStop: "Parar de ouvir",
    convListening: "Ouvindo…",
    convListenUnsupported: "A escuta ao vivo não é compatível com este navegador — tente o Chrome no computador ou Android.",
    saveWord: "Salvar palavra",
    saveTitle: "Salvar",
    saveToYourVocab: "Adicionar ao seu vocabulário",
    saveToYourVocabSub: "Sua lista de vocabulário padrão",
    saveAddToFolder: "Adicionar à pasta",
    saveAddToFolderSub: "Escolha uma pasta existente",
    saveCreateFolder: "Criar nova pasta",
    saveCreateFolderSub: "Crie uma nova pasta para esta palavra",
    saveCancel: "Cancelar",
    saveChooseFolder: "Escolha uma pasta",
    saveNoFolders: "Ainda não há pastas personalizadas — crie uma primeiro!",
    saveTo: "Salvar em",
    saveCreateAndSave: "Criar e salvar",
    saveFolderPlaceholder: "Nome da pasta (ex. かおりさん 授業)",
    saveBack: "← Voltar",
},
  ...
  "German": {
    ...
    tutorialScheduleDesc: "Das ist dein persönlicher wöchentlicher Lernplan. Hake unten eine Aufgabe ab — und beobachte, wie dein Fortschrittsbalken wächst.",
    tutorialVocabularyDesc: "Probier's gleich aus: Suche nach einem Wort (z. B. 食べる) und speichere es in deinem eigenen Stapel. Gespeicherte Wörter kannst du jederzeit mit Karteikarten wiederholen.",
    ...
    feedbackChecking: "Wird überprüft...",
    feedbackAlreadySubmitted: "Du hast dein einmaliges Feedback bereits gesendet. Danke! (Von GAKU eingeladene Studierende können beliebig oft Feedback senden.)",
    feedbackSuccess: "Danke — dein Feedback wurde gesendet.",
    feedbackPlaceholder: "Was sollen wir verbessern, oder was beschäftigt dich?",
    feedbackRejected: "Diese Nachricht konnte nicht akzeptiert werden. Bitte formuliere sie ohne persönliche Beleidigungen, Belästigung oder diskriminierende Sprache um.",
    feedbackError: "Beim Senden deines Feedbacks ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    ...
    jlptFormTitle: "Kostenloser JLPT-Bewertungsbericht — JETZT BEWERBEN",
    jlptQuestionLevel: "Welchen JLPT-Level möchtest du machen?",
    jlptQuestionMode: "Wie möchtest du ihn machen?",
    jlptModeSelf: "Alleine",
    jlptModeTrial: "Im Rahmen einer kostenlosen Probestunde",
    jlptQuestionSection: "Welchen Teil des JLPT möchtest du machen?",
    jlptSectionLanguage: "Sprachkenntnisse (Wortschatz/Grammatik)",
    jlptSectionReading: "Leseverständnis",
    jlptSectionListening: "Hörverständnis",
    jlptSectionAll: "Alles",
    jlptSubmit: "Absenden",
    ...
    pronGenerateBtn: "Ausspracheübung erstellen",
    pronNoItems: "In diesem Inhalt wurden keine passend langen Sätze gefunden. Versuche, mehr Text einzufügen.",
    pronReadMode: "👀 Lesen",
    pronListenMode: "👂 Hören",
    pronRevealText: "Text anzeigen",
    pronHideTextBtn: "Text ausblenden",
    pronListenFirst: "Tippe auf Hören und versuche dann, es nachzusprechen.",
    pronRecordPrompt: "Jetzt laut aussprechen",
    pronCorrect: "Richtig! 🎉",
    pronYourAttempt: "Du hast gesagt:",
    pronTargetLabel: "Ziel:",
    pronTryAgain: "Erneut versuchen",
    pronAddNewLabel: "Ein Wort oder einen Satz hinzufügen",
    pronAddNewPlaceholder: "Ein japanisches Wort oder einen Satz eingeben oder einfügen...",
    pronAddBtn: "Wort/Satz hinzufügen",
    pronBreakBtn: "🔍 In Teile zerlegen",
    pronBreaking: "Wird zerlegt...",
    pronBreakFailed: "Konnte nicht zerlegt werden. Bitte erneut versuchen.",
    speed08: "🐢 0,8x",
    speed05: "🐌 0,5x",
    ...
    freePlanGakuStudentHint: "GAKU-Schüler mit Unterricht erhalten die App kostenlos inklusive. Kein Code? Buche eine Stunde, um einer zu werden →",
    ...
    wantToJoinGaku: "Möchtest du bei GAKU mitmachen?",
    checkLater: "Später erneut prüfen",
    studyPlanReadyTitle: "Dein Lernplan ist fertig!",
    studyPlanReadyDesc: "Schalte deinen persönlichen Wochenplan, Übungssätze und Vokabel-Tools frei.",
    appOnlyLabel: "📱 NUR APP",
    monthlyLabel: "MONATLICH",
    perMonth: "/ Monat",
    threeMonthsSave5: "3 MONATE · 5 % sparen",
    sixMonthsSave10: "6 MONATE · 10 % sparen ⭐",
    appLessonsLabel: "🎓 APP + UNTERRICHT · 50 % Rabatt auf den Unterricht",
    threeMonthsSave5_30min: "3 MONATE · 5 % sparen · 30 Min/Monat",
    threeMonthsSave5_1hr: "3 MONATE · 5 % sparen · 1 Std/Monat",
    sixMonthsSave5_30min: "6 MONATE · 5 % sparen · 30 Min/Monat ⭐",
    sixMonthsSave10_1hr: "6 MONATE · 10 % sparen · 1 Std/Monat ⭐ Bestes Angebot",
    loginTitle: "Anmelden",
    signupTitle: "Konto erstellen",
    passwordPlaceholder: "Passwort",
    invitationCodeOptional: "GAKU-Einladungscode (optional)",
    loginButton: "Anmelden",
    signupButton: "Registrieren",
    needAccount: "Kein Konto? Jetzt registrieren",
    haveAccount: "Schon ein Konto? Anmelden",
    deviceApprovalTitle: "Neues Gerät erkannt",
    deviceApprovalDesc: "Wir haben dir und GAKU eine Bestätigungs-E-Mail gesendet. Sobald beide zugestimmt haben, wird dieses Gerät freigeschaltet — bitte prüfe dein Postfach.",
    convOrDivider: "ODER",
    convDescLive: "Spiele ein YouTube-Video mit Ton in der Nähe deines Mikrofons ab. GAKU hört dem echten Dialog zu und hilft dir Zeile für Zeile, ihn zu verstehen, und gibt dir Hinweise, wie du antworten könntest.",
    convHeardTitle: "Was GAKU gehört hat",
    convClearBtn: "🗑 Löschen",
    convHintBtn: "Wie würdest du antworten? (4 Optionen)",
    convHintLoading: "Antwortvorschläge werden überlegt...",
    convTryAgain: "↺ Erneut versuchen",
    convListenTitle: "Mit einem Video mithören",
    convListenDesc: "Spiele ein YouTube-Video mit Ton in der Nähe deines Mikrofons ab. GAKU hört zu und erstellt die Transkription oben für dich — tippe dann wie gewohnt auf \"Konversationsübung erstellen\".",
    convListenStart: "Zuhören starten",
    convListenStop: "Zuhören stoppen",
    convListening: "Höre zu…",
    convListenUnsupported: "Live-Zuhören wird in diesem Browser nicht unterstützt — versuche es mit Chrome am Desktop oder auf Android.",
    saveWord: "Wort speichern",
    saveTitle: "Speichern",
    saveToYourVocab: "Zu deinem Vokabular hinzufügen",
    saveToYourVocabSub: "Deine Standard-Vokabelliste",
    saveAddToFolder: "Zu Ordner hinzufügen",
    saveAddToFolderSub: "Einen vorhandenen Ordner wählen",
    saveCreateFolder: "Neuen Ordner erstellen",
    saveCreateFolderSub: "Einen neuen Ordner für dieses Wort erstellen",
    saveCancel: "Abbrechen",
    saveChooseFolder: "Ordner auswählen",
    saveNoFolders: "Noch keine eigenen Ordner — erstelle zuerst einen!",
    saveTo: "Speichern in",
    saveCreateAndSave: "Erstellen & speichern",
    saveFolderPlaceholder: "Ordnername (z.B. かおりさん 授業)",
    saveBack: "← Zurück",
},
  ...
  "Italian": {
    ...
    tutorialScheduleDesc: "Questo è il tuo piano di studio settimanale personalizzato. Prova a spuntare un'attività qui sotto — poi guarda la tua barra di progresso avanzare.",
    tutorialVocabularyDesc: "Provalo subito: cerca una parola (ad es. 食べる) e salvala nel tuo mazzo personale. Potrai ripassare le parole salvate quando vuoi con le flashcard.",
    ...
    feedbackChecking: "Verifica in corso...",
    feedbackAlreadySubmitted: "Hai già inviato il tuo feedback unico. Grazie! (Gli studenti invitati da GAKU possono inviarne quante volte vogliono.)",
    feedbackSuccess: "Grazie — il tuo feedback è stato inviato.",
    feedbackPlaceholder: "Cosa vorresti che migliorassimo, o cosa hai in mente?",
    feedbackRejected: "Questo messaggio non può essere accettato. Riformulalo senza insulti personali, molestie o linguaggio discriminatorio.",
    feedbackError: "Si è verificato un errore durante l'invio del tuo feedback. Riprova.",
    ...
    jlptFormTitle: "Rapporto di valutazione JLPT gratuito — CANDIDATI ORA",
    jlptQuestionLevel: "Quale livello del JLPT vuoi sostenere?",
    jlptQuestionMode: "Come preferisci sostenerlo?",
    jlptModeSelf: "Da solo",
    jlptModeTrial: "Farlo durante una lezione di prova gratuita",
    jlptQuestionSection: "Quale parte del JLPT vuoi fare?",
    jlptSectionLanguage: "Conoscenza della lingua (Vocabolario/Grammatica)",
    jlptSectionReading: "Lettura",
    jlptSectionListening: "Ascolto",
    jlptSectionAll: "Tutto",
    jlptSubmit: "Invia",
    ...
    pronGenerateBtn: "Crea pratica di pronuncia",
    pronNoItems: "Non sono state trovate frasi di lunghezza adatta in questo contenuto. Prova a incollare più testo.",
    pronReadMode: "👀 Leggi",
    pronListenMode: "👂 Ascolta",
    pronRevealText: "Mostra testo",
    pronHideTextBtn: "Nascondi testo",
    pronListenFirst: "Tocca Ascolta, poi prova a ripeterlo.",
    pronRecordPrompt: "Ora dillo ad alta voce",
    pronCorrect: "Corretto! 🎉",
    pronYourAttempt: "Hai detto:",
    pronTargetLabel: "Obiettivo:",
    pronTryAgain: "Riprova",
    pronAddNewLabel: "Aggiungi una parola o frase",
    pronAddNewPlaceholder: "Digita o incolla una parola o frase giapponese...",
    pronAddBtn: "Aggiungi parola/frase",
    pronBreakBtn: "🔍 Scomponi la frase",
    pronBreaking: "Scomposizione in corso...",
    pronBreakFailed: "Impossibile scomporre. Riprova.",
    speed08: "🐢 0,8x",
    speed05: "🐌 0,5x",
    ...
    freePlanGakuStudentHint: "Gli studenti con lezioni GAKU ricevono l'app inclusa gratis. Nessun codice? Prenota una lezione per diventarlo →",
    ...
    wantToJoinGaku: "Vuoi unirti a GAKU?",
    checkLater: "Controlla di nuovo più tardi",
    studyPlanReadyTitle: "Il tuo piano di studio è pronto!",
    studyPlanReadyDesc: "Sblocca il tuo programma settimanale personalizzato, gli esercizi e gli strumenti di vocabolario.",
    appOnlyLabel: "📱 SOLO APP",
    monthlyLabel: "MENSILE",
    perMonth: "/ mese",
    threeMonthsSave5: "3 MESI · Risparmia il 5%",
    sixMonthsSave10: "6 MESI · Risparmia il 10% ⭐",
    appLessonsLabel: "🎓 APP + LEZIONI · 50% di sconto sulle lezioni",
    threeMonthsSave5_30min: "3 MESI · Risparmia il 5% · 30min/mese",
    threeMonthsSave5_1hr: "3 MESI · Risparmia il 5% · 1h/mese",
    sixMonthsSave5_30min: "6 MESI · Risparmia il 5% · 30min/mese ⭐",
    sixMonthsSave10_1hr: "6 MESI · Risparmia il 10% · 1h/mese ⭐ Offerta migliore",
    loginTitle: "Accedi",
    signupTitle: "Crea il tuo account",
    passwordPlaceholder: "Password",
    invitationCodeOptional: "Codice di invito GAKU (facoltativo)",
    loginButton: "Accedi",
    signupButton: "Registrati",
    needAccount: "Non hai un account? Registrati",
    haveAccount: "Hai già un account? Accedi",
    deviceApprovalTitle: "Nuovo dispositivo rilevato",
    deviceApprovalDesc: "Abbiamo inviato un'email di approvazione a te e a GAKU. Una volta approvato da entrambi, questo dispositivo verrà sbloccato — controlla la tua posta in arrivo.",
    convOrDivider: "OPPURE",
    convDescLive: "Riproduci un video di YouTube con l'audio vicino al microfono. GAKU ascolta il dialogo reale e, riga per riga, ti aiuta a capirlo e ti suggerisce come rispondere.",
    convHeardTitle: "Cosa ha sentito GAKU",
    convClearBtn: "🗑 Cancella",
    convHintBtn: "Come risponderesti? (4 opzioni)",
    convHintLoading: "Sto pensando a suggerimenti di risposta...",
    convTryAgain: "↺ Riprova",
    convListenTitle: "Ascolta insieme a un video",
    convListenDesc: "Riproduci un video di YouTube con l'audio vicino al microfono. GAKU ascolterà e creerà la trascrizione qui sopra per te — poi tocca \"Crea esercizio di conversazione\" come al solito.",
    convListenStart: "Inizia ad ascoltare",
    convListenStop: "Interrompi l'ascolto",
    convListening: "In ascolto…",
    convListenUnsupported: "L'ascolto dal vivo non è supportato da questo browser — prova Chrome su desktop o Android.",
    saveWord: "Salva parola",
    saveTitle: "Salva",
    saveToYourVocab: "Aggiungi al tuo vocabolario",
    saveToYourVocabSub: "La tua lista di vocabolario predefinita",
    saveAddToFolder: "Aggiungi a cartella",
    saveAddToFolderSub: "Scegli una cartella esistente",
    saveCreateFolder: "Crea nuova cartella",
    saveCreateFolderSub: "Crea una nuova cartella per questa parola",
    saveCancel: "Annulla",
    saveChooseFolder: "Scegli una cartella",
    saveNoFolders: "Nessuna cartella personalizzata ancora — creane una prima!",
    saveTo: "Salva in",
    saveCreateAndSave: "Crea e salva",
    saveFolderPlaceholder: "Nome della cartella (es. かおりさん 授業)",
    saveBack: "← Indietro",
},
  ...
  "Chinese (Simplified)": {
    ...
    tutorialNextBtn: "下一步 →",
    tutorialScheduleDesc: "这是你的个性化每周学习计划。试着勾选下面的一项任务——然后看着进度条不断增长。",
    tutorialVocabularyDesc: "现在就试试：搜索一个单词(比如食べる)并保存到你自己的单词本。保存的单词可以随时用抽认卡复习。",
    ...
    feedbackChecking: "正在检查...",
    feedbackAlreadySubmitted: "你已经提交过唯一一次反馈了，谢谢！(受GAKU邀请的学生可以随时多次提交。)",
    feedbackSuccess: "谢谢——你的反馈已发送。",
    feedbackPlaceholder: "你希望我们改进什么，或者有什么想说的？",
    feedbackRejected: "该留言未能被接受。请去除人身攻击、骚扰或歧视性语言后重新表述。",
    feedbackError: "发送反馈时出现问题，请重试。",
    ...
    jlptFormTitle: "JLPT免费评估报告 — 立即申请",
    jlptQuestionLevel: "您想参加哪个等级的JLPT？",
    jlptQuestionMode: "您希望以什么方式参加？",
    jlptModeSelf: "自己完成",
    jlptModeTrial: "作为免费体验课的一部分完成",
    jlptQuestionSection: "您想做JLPT的哪个部分？",
    jlptSectionLanguage: "语言知识（词汇/语法）",
    jlptSectionReading: "阅读",
    jlptSectionListening: "听力",
    jlptSectionAll: "全部",
    jlptSubmit: "提交",
    jlptSubmitting: "提交中…",
    jlptBack: "返回",
    ...
    pronGenerateBtn: "生成发音练习",
    pronNoItems: "未能在该内容中找到适合练习长度的句子。请尝试粘贴更多文本。",
    pronReadMode: "👀 朗读",
    pronListenMode: "👂 聆听",
    pronRevealText: "显示文本",
    pronHideTextBtn: "隐藏文本",
    pronListenFirst: "点击“聆听”,然后试着跟读。",
    pronRecordPrompt: "现在大声说出来",
    pronCorrect: "正确!🎉",
    pronYourAttempt: "你说的是:",
    pronTargetLabel: "目标:",
    pronTryAgain: "再试一次",
    pronAddNewLabel: "添加单词或句子",
    pronAddNewPlaceholder: "输入或粘贴一个日语单词或句子...",
    pronAddBtn: "添加单词/句子",
    pronBreakBtn: "🔍 拆分短语",
    pronBreaking: "正在拆分...",
    pronBreakFailed: "无法拆分,请重试。",
    speed08: "🐢 0.8倍速",
    speed05: "🐌 0.5倍速",
    translateBtn: "翻译",
    ...
    freePlanGakuStudentHint: "上GAKU课程的学生可免费获得应用。没有邀请码？预约一节课成为GAKU学生 →",
    invitationCodeLabel: "邀请码",
    inviteCodePlaceholder: "输入邀请码...",
    confirmCode: "确认",
    invalidCode: "邀请码无效，请重试。",
    wantToJoinGaku: "想加入GAKU吗？",
    checkLater: "稍后再查看",
    studyPlanReadyTitle: "您的学习计划已准备就绪！",
    studyPlanReadyDesc: "解锁您的个性化每周计划、练习题和词汇工具。",
    appOnlyLabel: "📱 仅限应用",
    monthlyLabel: "月付",
    perMonth: "/ 月",
    threeMonthsSave5: "3个月 · 节省5%",
    sixMonthsSave10: "6个月 · 节省10% ⭐",
    appLessonsLabel: "🎓 应用+课程 · 课程5折优惠",
    threeMonthsSave5_30min: "3个月 · 节省5% · 每月30分钟",
    threeMonthsSave5_1hr: "3个月 · 节省5% · 每月1小时",
    sixMonthsSave5_30min: "6个月 · 节省5% · 每月30分钟 ⭐",
    sixMonthsSave10_1hr: "6个月 · 节省10% · 每月1小时 ⭐ 最超值",
    loginTitle: "登录",
    signupTitle: "创建您的账户",
    passwordPlaceholder: "密码",
    invitationCodeOptional: "GAKU邀请码（可选）",
    loginButton: "登录",
    signupButton: "注册",
    needAccount: "还没有账户？立即注册",
    haveAccount: "已有账户？立即登录",
    deviceApprovalTitle: "检测到新设备",
    deviceApprovalDesc: "我们已向您和GAKU发送了确认邮件。双方确认后，该设备即可解锁 — 请查看您的收件箱。",
    convOrDivider: "或",
    convDescLive: "在麦克风附近播放开启声音的YouTube视频。GAKU会实时听取真实对话，并逐句帮助您理解，同时提示您该如何回应。",
    convHeardTitle: "GAKU听到的内容",
    convClearBtn: "🗑 清除",
    convHintBtn: "你会怎么回答？（4个选项）",
    convHintLoading: "正在思考回答提示...",
    convTryAgain: "↺ 重试",
    convListenTitle: "跟随视频一起听",
    convListenDesc: "在麦克风附近播放开启声音的YouTube视频。GAKU会听取内容并为您生成上方的文字记录 — 然后照常点击\"生成对话练习\"。",
    convListenStart: "开始听取",
    convListenStop: "停止听取",
    convListening: "正在听取…",
    convListenUnsupported: "此浏览器不支持实时听取功能 — 请尝试在电脑或安卓设备上使用Chrome浏览器。",
    saveWord: "保存单词",
    saveTitle: "保存",
    saveToYourVocab: "添加到我的词汇表",
    saveToYourVocabSub: "您的默认词汇表",
    saveAddToFolder: "添加到文件夹",
    saveAddToFolderSub: "选择一个现有文件夹",
    saveCreateFolder: "创建新文件夹",
    saveCreateFolderSub: "为该单词创建一个新文件夹",
    saveCancel: "取消",
    saveChooseFolder: "选择一个文件夹",
    saveNoFolders: "还没有自定义文件夹 — 先创建一个吧！",
    saveTo: "保存到",
    saveCreateAndSave: "创建并保存",
    saveFolderPlaceholder: "文件夹名称（例如 かおりさん 授業）",
    saveBack: "← 返回",
},
  ...
  "Chinese (Traditional)": {
    ...
    tutorialNextBtn: "下一步 →",
    tutorialScheduleDesc: "這是你的個人化每週學習計畫。試著勾選下面的一項任務——然後看著進度條不斷增長。",
    tutorialVocabularyDesc: "現在就試試：搜尋一個單字(例如食べる)並儲存到你自己的單字本。儲存的單字可以隨時用抽認卡複習。",
    ...
    feedbackChecking: "檢查中...",
    feedbackAlreadySubmitted: "你已經提交過唯一一次意見回饋了，謝謝！(受GAKU邀請的學生可以隨時多次提交。)",
    feedbackSuccess: "謝謝——你的意見回饋已送出。",
    feedbackPlaceholder: "你希望我們改進什麼，或是有什麼想說的？",
    feedbackRejected: "此留言未能被接受。請去除人身攻擊、騷擾或歧視性語言後重新表述。",
    feedbackError: "傳送意見回饋時發生問題，請再試一次。",
    ...
    jlptFormTitle: "JLPT免費評估報告 — 立即申請",
    jlptQuestionLevel: "您想參加哪個等級的JLPT？",
    jlptQuestionMode: "您希望以什麼方式參加？",
    jlptModeSelf: "自己完成",
    jlptModeTrial: "作為免費體驗課的一部分完成",
    jlptQuestionSection: "您想做JLPT的哪個部分？",
    jlptSectionLanguage: "語言知識（詞彙/文法）",
    jlptSectionReading: "閱讀",
    jlptSectionListening: "聽力",
    jlptSectionAll: "全部",
    jlptSubmit: "提交",
    jlptSubmitting: "提交中…",
    jlptBack: "返回",
    ...
    pronGenerateBtn: "建立發音練習",
    pronNoItems: "未能在該內容中找到適合練習長度的句子。請嘗試貼上更多文本。",
    pronReadMode: "👀 朗讀",
    pronListenMode: "👂 聆聽",
    pronRevealText: "顯示文本",
    pronHideTextBtn: "隱藏文本",
    pronListenFirst: "點擊「聆聽」,然後試著跟讀。",
    pronRecordPrompt: "現在大聲說出來",
    pronCorrect: "正確!🎉",
    pronYourAttempt: "你說的是:",
    pronTargetLabel: "目標:",
    pronTryAgain: "再試一次",
    pronAddNewLabel: "新增單字或句子",
    pronAddNewPlaceholder: "輸入或貼上一個日語單字或句子...",
    pronAddBtn: "新增單字/句子",
    pronBreakBtn: "🔍 拆分片語",
    pronBreaking: "正在拆分...",
    pronBreakFailed: "無法拆分,請再試一次。",
    speed08: "🐢 0.8倍速",
    speed05: "🐌 0.5倍速",
    translateBtn: "翻譯",
    ...
    freePlanGakuStudentHint: "上GAKU課程的學生可免費獲得應用程式。沒有邀請碼？預約一堂課成為GAKU學生 →",
    invitationCodeLabel: "邀請碼",
    inviteCodePlaceholder: "輸入邀請碼...",
    confirmCode: "確認",
    invalidCode: "邀請碼無效，請再試一次。",
    wantToJoinGaku: "想加入GAKU嗎？",
    checkLater: "稍後再查看",
    studyPlanReadyTitle: "您的學習計畫已準備就緒！",
    studyPlanReadyDesc: "解鎖您的個人化每週時間表、練習題與詞彙工具。",
    appOnlyLabel: "📱 僅限應用程式",
    monthlyLabel: "月付",
    perMonth: "/ 月",
    threeMonthsSave5: "3個月 · 節省5%",
    sixMonthsSave10: "6個月 · 節省10% ⭐",
    appLessonsLabel: "🎓 應用程式+課程 · 課程5折優惠",
    threeMonthsSave5_30min: "3個月 · 節省5% · 每月30分鐘",
    threeMonthsSave5_1hr: "3個月 · 節省5% · 每月1小時",
    sixMonthsSave5_30min: "6個月 · 節省5% · 每月30分鐘 ⭐",
    sixMonthsSave10_1hr: "6個月 · 節省10% · 每月1小時 ⭐ 最超值",
    loginTitle: "登入",
    signupTitle: "建立您的帳戶",
    passwordPlaceholder: "密碼",
    invitationCodeOptional: "GAKU邀請碼（選填）",
    loginButton: "登入",
    signupButton: "註冊",
    needAccount: "還沒有帳戶？立即註冊",
    haveAccount: "已經有帳戶？立即登入",
    deviceApprovalTitle: "偵測到新裝置",
    deviceApprovalDesc: "我們已寄送確認信給您和GAKU。雙方確認後，此裝置即可解鎖 — 請查看您的收件匣。",
    convOrDivider: "或",
    convDescLive: "在麥克風附近播放開啟聲音的YouTube影片。GAKU會即時聽取真實對話，並逐句幫助您理解，同時提示您該如何回應。",
    convHeardTitle: "GAKU聽到的內容",
    convClearBtn: "🗑 清除",
    convHintBtn: "你會怎麼回答？（4個選項）",
    convHintLoading: "正在思考回答提示...",
    convTryAgain: "↺ 重試",
    convListenTitle: "跟著影片一起聽",
    convListenDesc: "在麥克風附近播放開啟聲音的YouTube影片。GAKU會聽取內容並為您產生上方的文字記錄 — 接著照常點擊\"建立對話練習\"。",
    convListenStart: "開始聽取",
    convListenStop: "停止聽取",
    convListening: "正在聽取…",
    convListenUnsupported: "此瀏覽器不支援即時聽取功能 — 請嘗試在電腦或Android裝置上使用Chrome瀏覽器。",
    saveWord: "儲存單字",
    saveTitle: "儲存",
    saveToYourVocab: "加入我的詞彙表",
    saveToYourVocabSub: "您的預設詞彙表",
    saveAddToFolder: "加入資料夾",
    saveAddToFolderSub: "選擇一個現有資料夾",
    saveCreateFolder: "建立新資料夾",
    saveCreateFolderSub: "為此單字建立一個新資料夾",
    saveCancel: "取消",
    saveChooseFolder: "選擇一個資料夾",
    saveNoFolders: "尚無自訂資料夾 — 先建立一個吧！",
    saveTo: "儲存至",
    saveCreateAndSave: "建立並儲存",
    saveFolderPlaceholder: "資料夾名稱（例如 かおりさん 授業）",
    saveBack: "← 返回",
},
  ...
  "Korean": {
    ...
    tutorialNextBtn: "다음 →",
    tutorialScheduleDesc: "이것은 당신만의 맞춤 주간 학습 계획입니다. 아래에서 작업 하나에 체크해 보세요 — 그리고 진행률 바가 채워지는 것을 지켜보세요.",
    tutorialVocabularyDesc: "지금 해보세요: 단어를 하나 검색해서(예: 食べる) 나만의 단어장에 저장해 보세요. 저장한 단어는 언제든지 플래시카드로 복습할 수 있어요.",
    ...
    feedbackChecking: "확인 중...",
    feedbackAlreadySubmitted: "이미 1회 피드백을 제출하셨습니다. 감사합니다! (GAKU 초대 학생은 몇 번이든 제출할 수 있습니다.)",
    feedbackSuccess: "감사합니다 — 피드백이 전송되었습니다.",
    feedbackPlaceholder: "무엇을 개선하면 좋을지, 또는 어떤 생각이 있으신가요?",
    feedbackRejected: "이 메시지는 접수될 수 없습니다. 개인 비방, 괴롭힘, 차별적 표현 없이 다시 작성해 주세요.",
    feedbackError: "피드백 전송 중 문제가 발생했습니다. 다시 시도해 주세요.",
    ...
    jlptFormTitle: "JLPT 무료 평가 리포트 — 지금 신청하기",
    jlptQuestionLevel: "어떤 JLPT 급수를 응시하고 싶으신가요?",
    jlptQuestionMode: "어떻게 응시하고 싶으신가요?",
    jlptModeSelf: "혼자서",
    jlptModeTrial: "무료 체험 수업의 일부로 응시",
    jlptQuestionSection: "JLPT의 어느 부분을 하고 싶으신가요?",
    jlptSectionLanguage: "언어지식(어휘/문법)",
    jlptSectionReading: "독해",
    jlptSectionListening: "청해",
    jlptSectionAll: "전체",
    jlptSubmit: "제출",
    jlptSubmitting: "제출 중…",
    jlptBack: "뒤로",
    ...
    pronGenerateBtn: "발음 연습 만들기",
    pronNoItems: "해당 콘텐츠에서 연습하기 적당한 길이의 문장을 찾지 못했습니다. 텍스트를 더 붙여넣어 보세요.",
    pronReadMode: "👀 읽기",
    pronListenMode: "👂 듣기",
    pronRevealText: "텍스트 표시",
    pronHideTextBtn: "텍스트 숨기기",
    pronListenFirst: "듣기를 누른 다음 따라 말해보세요.",
    pronRecordPrompt: "이제 소리 내어 말해보세요",
    pronCorrect: "정답이에요! 🎉",
    pronYourAttempt: "당신이 말한 것:",
    pronTargetLabel: "목표:",
    pronTryAgain: "다시 시도",
    pronAddNewLabel: "단어나 문장 추가",
    pronAddNewPlaceholder: "일본어 단어나 문장을 입력하거나 붙여넣으세요...",
    pronAddBtn: "단어/문장 추가",
    pronBreakBtn: "🔍 구문 분해하기",
    pronBreaking: "분해하는 중...",
    pronBreakFailed: "분해할 수 없습니다. 다시 시도해 주세요.",
    speed08: "🐢 0.8배속",
    speed05: "🐌 0.5배속",
    translateBtn: "번역",
    ...
    freePlanGakuStudentHint: "GAKU 레슨을 받는 학생은 앱을 무료로 이용할 수 있습니다. 코드가 없나요? 레슨을 예약해 GAKU 학생이 되어보세요 →",
    invitationCodeLabel: "초대 코드",
    inviteCodePlaceholder: "초대 코드를 입력하세요...",
    confirmCode: "확인",
    invalidCode: "잘못된 코드입니다. 다시 시도해 주세요.",
    wantToJoinGaku: "GAKU에 가입하고 싶으신가요?",
    checkLater: "나중에 다시 확인",
    studyPlanReadyTitle: "학습 플랜이 준비되었습니다!",
    studyPlanReadyDesc: "맞춤형 주간 일정, 연습 세트, 어휘 도구의 잠금을 해제하세요.",
    appOnlyLabel: "📱 앱 전용",
    monthlyLabel: "월간",
    perMonth: "/ 월",
    threeMonthsSave5: "3개월 · 5% 절약",
    sixMonthsSave10: "6개월 · 10% 절약 ⭐",
    appLessonsLabel: "🎓 앱 + 수업 · 수업 50% 할인",
    threeMonthsSave5_30min: "3개월 · 5% 절약 · 월 30분",
    threeMonthsSave5_1hr: "3개월 · 5% 절약 · 월 1시간",
    sixMonthsSave5_30min: "6개월 · 5% 절약 · 월 30분 ⭐",
    sixMonthsSave10_1hr: "6개월 · 10% 절약 · 월 1시간 ⭐ 최고의 혜택",
    loginTitle: "로그인",
    signupTitle: "계정 만들기",
    passwordPlaceholder: "비밀번호",
    invitationCodeOptional: "GAKU 초대 코드 (선택 사항)",
    loginButton: "로그인",
    signupButton: "가입하기",
    needAccount: "계정이 없으신가요? 가입하기",
    haveAccount: "이미 계정이 있으신가요? 로그인",
    deviceApprovalTitle: "새 기기가 감지되었습니다",
    deviceApprovalDesc: "회원님과 GAKU에 승인 이메일을 보냈습니다. 양쪽 모두 승인하면 이 기기의 잠금이 해제됩니다 — 받은편지함을 확인해 주세요.",
    convOrDivider: "또는",
    convDescLive: "마이크 근처에서 소리를 켠 채로 유튜브 영상을 재생하세요. GAKU가 실제 대화를 듣고 한 줄씩 이해를 도와주며 어떻게 대답할지 힌트를 줍니다.",
    convHeardTitle: "GAKU가 들은 내용",
    convClearBtn: "🗑 지우기",
    convHintBtn: "어떻게 대답하시겠어요? (4지선다)",
    convHintLoading: "답변 힌트를 생각하는 중...",
    convTryAgain: "↺ 다시 시도",
    convListenTitle: "영상과 함께 듣기",
    convListenDesc: "마이크 근처에서 소리를 켠 채로 유튜브 영상을 재생하세요. GAKU가 듣고 위에 스크립트를 만들어 드립니다 — 그런 다음 평소처럼 \"대화 연습 만들기\"를 누르세요.",
    convListenStart: "듣기 시작",
    convListenStop: "듣기 중지",
    convListening: "듣는 중…",
    convListenUnsupported: "이 브라우저에서는 실시간 듣기가 지원되지 않습니다 — 데스크톱이나 안드로이드의 Chrome을 사용해 보세요.",
    saveWord: "단어 저장",
    saveTitle: "저장",
    saveToYourVocab: "내 단어장에 추가",
    saveToYourVocabSub: "기본 단어장",
    saveAddToFolder: "폴더에 추가",
    saveAddToFolderSub: "기존 폴더 선택",
    saveCreateFolder: "새 폴더 만들기",
    saveCreateFolderSub: "이 단어를 위한 새 폴더 만들기",
    saveCancel: "취소",
    saveChooseFolder: "폴더 선택",
    saveNoFolders: "아직 사용자 폴더가 없습니다 — 먼저 만들어 보세요!",
    saveTo: "저장 위치",
    saveCreateAndSave: "만들고 저장",
    saveFolderPlaceholder: "폴더 이름 (예: かおりさん 授業)",
    saveBack: "← 뒤로",
},
  ...
  "Thai": {
    ...
    tutorialScheduleDesc: "นี่คือแผนการเรียนรายสัปดาห์ที่ปรับให้เหมาะกับคุณ ลองทำเครื่องหมายงานด้านล่างสักหนึ่งอย่าง แล้วดูแถบความคืบหน้าค่อย ๆ เต็มขึ้น",
    tutorialVocabularyDesc: "ลองเลย: ค้นหาคำศัพท์หนึ่งคำ (เช่น 食べる) แล้วบันทึกลงในชุดคำศัพท์ของคุณ คุณสามารถทบทวนคำที่บันทึกไว้ได้ทุกเมื่อด้วยแฟลชการ์ด",
    ...
    feedbackChecking: "กำลังตรวจสอบ...",
    feedbackAlreadySubmitted: "คุณส่งความคิดเห็นครั้งเดียวไปแล้ว ขอบคุณค่ะ/ครับ! (นักเรียนที่ได้รับเชิญจาก GAKU สามารถส่งได้ไม่จำกัดจำนวนครั้ง)",
    feedbackSuccess: "ขอบคุณ — ความคิดเห็นของคุณถูกส่งแล้ว",
    feedbackPlaceholder: "คุณอยากให้เราปรับปรุงอะไร หรือมีอะไรอยู่ในใจ?",
    feedbackRejected: "ข้อความนี้ไม่สามารถรับได้ กรุณาเขียนใหม่โดยไม่มีการดูหมิ่นส่วนตัว การคุกคาม หรือถ้อยคำเลือกปฏิบัติ",
    feedbackError: "เกิดข้อผิดพลาดในการส่งความคิดเห็น กรุณาลองใหม่อีกครั้ง",
    ...
    jlptFormTitle: "รายงานประเมิน JLPT ฟรี — สมัครตอนนี้",
    jlptQuestionLevel: "คุณต้องการสอบ JLPT ระดับใด?",
    jlptQuestionMode: "คุณต้องการสอบแบบไหน?",
    jlptModeSelf: "ทำด้วยตัวเอง",
    jlptModeTrial: "ทำเป็นส่วนหนึ่งของบทเรียนทดลองฟรี",
    jlptQuestionSection: "คุณต้องการทำส่วนไหนของ JLPT?",
    jlptSectionLanguage: "ความรู้ทางภาษา (คำศัพท์/ไวยากรณ์)",
    jlptSectionReading: "การอ่าน",
    jlptSectionListening: "การฟัง",
    jlptSectionAll: "ทั้งหมด",
    jlptSubmit: "ส่ง",
    ...
    pronGenerateBtn: "สร้างแบบฝึกออกเสียง",
    pronNoItems: "ไม่พบประโยคที่มีความยาวเหมาะสมในเนื้อหานั้น ลองวางข้อความเพิ่มเติม",
    pronReadMode: "👀 อ่าน",
    pronListenMode: "👂 ฟัง",
    pronRevealText: "แสดงข้อความ",
    pronHideTextBtn: "ซ่อนข้อความ",
    pronListenFirst: "แตะฟัง แล้วลองพูดตาม",
    pronRecordPrompt: "ตอนนี้ลองพูดออกเสียงดัง ๆ",
    pronCorrect: "ถูกต้อง! 🎉",
    pronYourAttempt: "คุณพูดว่า:",
    pronTargetLabel: "เป้าหมาย:",
    pronTryAgain: "ลองอีกครั้ง",
    pronAddNewLabel: "เพิ่มคำหรือประโยค",
    pronAddNewPlaceholder: "พิมพ์หรือวางคำหรือประโยคภาษาญี่ปุ่น...",
    pronAddBtn: "เพิ่มคำ/ประโยค",
    pronBreakBtn: "🔍 แยกวลี",
    pronBreaking: "กำลังแยก...",
    pronBreakFailed: "ไม่สามารถแยกได้ ลองอีกครั้ง",
    speed08: "🐢 0.8เท่า",
    speed05: "🐌 0.5เท่า",
    translateBtn: "แปล",
    ...
    freePlanGakuStudentHint: "นักเรียนที่เรียนคอร์ส GAKU จะได้แอปฟรี ไม่มีรหัส? จองคอร์สเรียนเพื่อเป็นนักเรียน GAKU →",
    invitationCodeLabel: "รหัสคำเชิญ",
    inviteCodePlaceholder: "ป้อนรหัสคำเชิญ...",
    confirmCode: "ยืนยัน",
    invalidCode: "รหัสไม่ถูกต้อง กรุณาลองอีกครั้ง",
    wantToJoinGaku: "ต้องการเข้าร่วม GAKU ใช่ไหม?",
    checkLater: "ตรวจสอบอีกครั้งภายหลัง",
    studyPlanReadyTitle: "แผนการเรียนของคุณพร้อมแล้ว!",
    studyPlanReadyDesc: "ปลดล็อกตารางเรียนรายสัปดาห์ส่วนตัว ชุดแบบฝึกหัด และเครื่องมือคำศัพท์",
    appOnlyLabel: "📱 เฉพาะแอปเท่านั้น",
    monthlyLabel: "รายเดือน",
    perMonth: "/ เดือน",
    threeMonthsSave5: "3 เดือน · ประหยัด 5%",
    sixMonthsSave10: "6 เดือน · ประหยัด 10% ⭐",
    appLessonsLabel: "🎓 แอป + คอร์สเรียน · ส่วนลดคอร์สเรียน 50%",
    threeMonthsSave5_30min: "3 เดือน · ประหยัด 5% · 30 นาที/เดือน",
    threeMonthsSave5_1hr: "3 เดือน · ประหยัด 5% · 1 ชม./เดือน",
    sixMonthsSave5_30min: "6 เดือน · ประหยัด 5% · 30 นาที/เดือน ⭐",
    sixMonthsSave10_1hr: "6 เดือน · ประหยัด 10% · 1 ชม./เดือน ⭐ คุ้มที่สุด",
    loginTitle: "เข้าสู่ระบบ",
    signupTitle: "สร้างบัญชีของคุณ",
    passwordPlaceholder: "รหัสผ่าน",
    invitationCodeOptional: "รหัสคำเชิญ GAKU (ไม่บังคับ)",
    loginButton: "เข้าสู่ระบบ",
    signupButton: "สมัครสมาชิก",
    needAccount: "ยังไม่มีบัญชี? สมัครสมาชิก",
    haveAccount: "มีบัญชีอยู่แล้ว? เข้าสู่ระบบ",
    deviceApprovalTitle: "ตรวจพบอุปกรณ์ใหม่",
    deviceApprovalDesc: "เราได้ส่งอีเมลขออนุมัติไปยังคุณและ GAKU แล้ว เมื่อทั้งสองฝ่ายอนุมัติ อุปกรณ์นี้จะถูกปลดล็อก — กรุณาตรวจสอบกล่องจดหมายของคุณ",
    convOrDivider: "หรือ",
    convDescLive: "เปิดวิดีโอ YouTube ให้มีเสียงใกล้ไมโครโฟนของคุณ GAKU จะฟังบทสนทนาจริงและช่วยให้คุณเข้าใจทีละบรรทัด พร้อมแนะนำวิธีตอบกลับ",
    convHeardTitle: "สิ่งที่ GAKU ได้ยิน",
    convClearBtn: "🗑 ล้าง",
    convHintBtn: "คุณจะตอบอย่างไร? (4 ตัวเลือก)",
    convHintLoading: "กำลังคิดคำแนะนำการตอบ...",
    convTryAgain: "↺ ลองอีกครั้ง",
    convListenTitle: "ฟังไปพร้อมกับวิดีโอ",
    convListenDesc: "เปิดวิดีโอ YouTube ให้มีเสียงใกล้ไมโครโฟนของคุณ GAKU จะฟังและสร้างบทถอดความด้านบนให้คุณ — จากนั้นแตะ \"สร้างแบบฝึกหัดบทสนทนา\" ตามปกติ",
    convListenStart: "เริ่มฟัง",
    convListenStop: "หยุดฟัง",
    convListening: "กำลังฟัง…",
    convListenUnsupported: "เบราว์เซอร์นี้ไม่รองรับการฟังสด — ลองใช้ Chrome บนเดสก์ท็อปหรือ Android",
    saveWord: "บันทึกคำศัพท์",
    saveTitle: "บันทึก",
    saveToYourVocab: "เพิ่มลงในคำศัพท์ของคุณ",
    saveToYourVocabSub: "รายการคำศัพท์เริ่มต้นของคุณ",
    saveAddToFolder: "เพิ่มลงในโฟลเดอร์",
    saveAddToFolderSub: "เลือกโฟลเดอร์ที่มีอยู่",
    saveCreateFolder: "สร้างโฟลเดอร์ใหม่",
    saveCreateFolderSub: "สร้างโฟลเดอร์ใหม่สำหรับคำนี้",
    saveCancel: "ยกเลิก",
    saveChooseFolder: "เลือกโฟลเดอร์",
    saveNoFolders: "ยังไม่มีโฟลเดอร์ที่กำหนดเอง — สร้างอันแรกกันเลย!",
    saveTo: "บันทึกไปยัง",
    saveCreateAndSave: "สร้างและบันทึก",
    saveFolderPlaceholder: "ชื่อโฟลเดอร์ (เช่น かおりさん 授業)",
    saveBack: "← กลับ",
},
  ...
  "Malay": {
    ...
    tutorialScheduleDesc: "Ini ialah jadual belajar mingguan yang diperibadikan untuk anda. Cuba tandakan satu tugasan di bawah — kemudian lihat bar kemajuan anda bertambah.",
    tutorialVocabularyDesc: "Cubalah sekarang: cari satu perkataan (contohnya 食べる) dan simpan ke dalam set kad anda sendiri. Anda boleh mengulang kaji perkataan yang disimpan bila-bila masa dengan kad imbas.",
    ...
    feedbackChecking: "Sedang menyemak...",
    feedbackAlreadySubmitted: "Anda telah menghantar maklum balas sekali sahaja anda. Terima kasih! (Pelajar jemputan GAKU boleh menghantar seberapa banyak kali yang mereka mahu.)",
    feedbackSuccess: "Terima kasih — maklum balas anda telah dihantar.",
    feedbackPlaceholder: "Apa yang anda mahu kami perbaiki, atau apa yang terlintas di fikiran anda?",
    feedbackRejected: "Mesej ini tidak dapat diterima. Sila tulis semula tanpa hinaan peribadi, gangguan, atau bahasa diskriminasi.",
    feedbackError: "Berlaku ralat semasa menghantar maklum balas anda. Sila cuba lagi.",
    ...
    jlptFormTitle: "Laporan Penilaian JLPT Percuma — MOHON SEKARANG",
    jlptQuestionLevel: "Tahap JLPT manakah yang anda ingin ambil?",
    jlptQuestionMode: "Bagaimana anda lebih suka mengambilnya?",
    jlptModeSelf: "Sendiri",
    jlptModeTrial: "Ambil sebagai sebahagian daripada Pelajaran Percubaan Percuma",
    jlptQuestionSection: "Bahagian JLPT manakah yang anda ingin lakukan?",
    jlptSectionLanguage: "Pengetahuan bahasa (Kosa kata/Tatabahasa)",
    jlptSectionReading: "Bacaan",
    jlptSectionListening: "Mendengar",
    jlptSectionAll: "Semua",
    jlptSubmit: "Hantar",
    ...
    pronGenerateBtn: "Bina Latihan Sebutan",
    pronNoItems: "Tiada ayat bersaiz sesuai ditemui dalam kandungan itu. Cuba tampal lebih banyak teks.",
    pronReadMode: "👀 Baca",
    pronListenMode: "👂 Dengar",
    pronRevealText: "Tunjukkan teks",
    pronHideTextBtn: "Sembunyikan teks",
    pronListenFirst: "Ketik Dengar, kemudian cuba ulang semula.",
    pronRecordPrompt: "Sekarang sebutkan dengan kuat",
    pronCorrect: "Betul! 🎉",
    pronYourAttempt: "Anda sebut:",
    pronTargetLabel: "Sasaran:",
    pronTryAgain: "Cuba lagi",
    pronAddNewLabel: "Tambah perkataan atau ayat",
    pronAddNewPlaceholder: "Taip atau tampal perkataan atau ayat Jepun...",
    pronAddBtn: "Tambah perkataan/ayat",
    pronBreakBtn: "🔍 Pecahkan frasa",
    pronBreaking: "Memecahkan...",
    pronBreakFailed: "Tidak dapat memecahkan. Cuba lagi.",
    speed08: "🐢 0.8x",
    speed05: "🐌 0.5x",
    ...
    freePlanGakuStudentHint: "Pelajar yang mengambil kelas GAKU mendapat aplikasi ini percuma. Tiada kod? Tempah kelas untuk menjadi pelajar GAKU →",
    invitationCodeLabel: "KOD JEMPUTAN",
    inviteCodePlaceholder: "Masukkan kod jemputan...",
    confirmCode: "Sahkan",
    invalidCode: "Kod tidak sah. Sila cuba lagi.",
    wantToJoinGaku: "Mahu menyertai GAKU?",
    checkLater: "Semak semula kemudian",
    studyPlanReadyTitle: "Pelan pembelajaran anda sudah sedia!",
    studyPlanReadyDesc: "Buka kunci jadual mingguan peribadi, set latihan dan alat kosa kata anda.",
    appOnlyLabel: "📱 APLIKASI SAHAJA",
    monthlyLabel: "BULANAN",
    perMonth: "/ bulan",
    threeMonthsSave5: "3 BULAN · Jimat 5%",
    sixMonthsSave10: "6 BULAN · Jimat 10% ⭐",
    appLessonsLabel: "🎓 APLIKASI + KELAS · Diskaun 50% untuk kelas",
    threeMonthsSave5_30min: "3 BULAN · Jimat 5% · 30min/bulan",
    threeMonthsSave5_1hr: "3 BULAN · Jimat 5% · 1jam/bulan",
    sixMonthsSave5_30min: "6 BULAN · Jimat 5% · 30min/bulan ⭐",
    sixMonthsSave10_1hr: "6 BULAN · Jimat 10% · 1jam/bulan ⭐ Nilai Terbaik",
    loginTitle: "Log Masuk",
    signupTitle: "Cipta Akaun Anda",
    passwordPlaceholder: "Kata laluan",
    invitationCodeOptional: "Kod jemputan GAKU (pilihan)",
    loginButton: "Log Masuk",
    signupButton: "Daftar",
    needAccount: "Perlukan akaun? Daftar",
    haveAccount: "Sudah ada akaun? Log masuk",
    deviceApprovalTitle: "Peranti Baharu Dikesan",
    deviceApprovalDesc: "Kami telah menghantar e-mel kelulusan kepada anda dan GAKU. Setelah kedua-duanya diluluskan, peranti ini akan dibuka kunci — sila semak peti masuk anda.",
    convOrDivider: "ATAU",
    convDescLive: "Mainkan video YouTube dengan bunyi berhampiran mikrofon anda. GAKU mendengar dialog sebenar dan, baris demi baris, membantu anda memahaminya serta memberi petunjuk cara membalas.",
    convHeardTitle: "Apa yang GAKU dengar",
    convClearBtn: "🗑 Kosongkan",
    convHintBtn: "Bagaimana anda akan membalas? (4 pilihan)",
    convHintLoading: "Sedang memikirkan petunjuk jawapan...",
    convTryAgain: "↺ Cuba lagi",
    convListenTitle: "Dengar bersama video",
    convListenDesc: "Mainkan video YouTube dengan bunyi berhampiran mikrofon anda. GAKU akan mendengar dan membina transkrip di atas untuk anda — kemudian ketik \"Bina Latihan Perbualan\" seperti biasa.",
    convListenStart: "Mula mendengar",
    convListenStop: "Berhenti mendengar",
    convListening: "Sedang mendengar…",
    convListenUnsupported: "Mendengar langsung tidak disokong dalam pelayar ini — cuba Chrome pada desktop atau Android.",
    saveWord: "Simpan Perkataan",
    saveTitle: "Simpan",
    saveToYourVocab: "Tambah ke Kosa Kata Anda",
    saveToYourVocabSub: "Senarai kosa kata lalai anda",
    saveAddToFolder: "Tambah ke Folder",
    saveAddToFolderSub: "Pilih folder sedia ada",
    saveCreateFolder: "Cipta Folder Baharu",
    saveCreateFolderSub: "Buat folder baharu untuk perkataan ini",
    saveCancel: "Batal",
    saveChooseFolder: "Pilih folder",
    saveNoFolders: "Belum ada folder tersuai — cipta satu dahulu!",
    saveTo: "Simpan ke",
    saveCreateAndSave: "Cipta & Simpan",
    saveFolderPlaceholder: "Nama folder (cth. かおりさん 授業)",
    saveBack: "← Kembali",
},
  ...
  "Indonesian": {
    ...
    tutorialScheduleDesc: "Ini adalah rencana belajar mingguan yang dipersonalisasi untuk Anda. Coba centang satu tugas di bawah — lalu lihat bilah kemajuan Anda terisi.",
    tutorialVocabularyDesc: "Coba sekarang: cari satu kata (misalnya 食べる) dan simpan ke dek Anda sendiri. Anda bisa meninjau kata yang disimpan kapan saja dengan kartu flash.",
    ...
    feedbackChecking: "Memeriksa...",
    feedbackAlreadySubmitted: "Anda sudah mengirimkan masukan satu kali Anda. Terima kasih! (Siswa yang diundang GAKU dapat mengirim sebanyak yang mereka mau.)",
    feedbackSuccess: "Terima kasih — masukan Anda telah dikirim.",
    feedbackPlaceholder: "Apa yang ingin Anda kami tingkatkan, atau apa yang ada di pikiran Anda?",
    feedbackRejected: "Pesan ini tidak dapat diterima. Mohon tulis ulang tanpa penghinaan pribadi, pelecehan, atau bahasa diskriminatif.",
    feedbackError: "Terjadi kesalahan saat mengirim masukan Anda. Silakan coba lagi.",
    ...
    jlptFormTitle: "Laporan Penilaian JLPT Gratis — DAFTAR SEKARANG",
    jlptQuestionLevel: "Level JLPT mana yang ingin Anda ambil?",
    jlptQuestionMode: "Bagaimana Anda lebih suka mengambilnya?",
    jlptModeSelf: "Sendiri",
    jlptModeTrial: "Ambil sebagai bagian dari Kelas Percobaan Gratis",
    jlptQuestionSection: "Bagian JLPT mana yang ingin Anda kerjakan?",
    jlptSectionLanguage: "Pengetahuan bahasa (Kosakata/Tata bahasa)",
    jlptSectionReading: "Membaca",
    jlptSectionListening: "Mendengarkan",
    jlptSectionAll: "Semua",
    jlptSubmit: "Kirim",
    ...
    pronGenerateBtn: "Buat Latihan Pengucapan",
    pronNoItems: "Tidak ditemukan kalimat dengan panjang yang sesuai dalam konten tersebut. Coba tempel lebih banyak teks.",
    pronReadMode: "👀 Baca",
    pronListenMode: "👂 Dengarkan",
    pronRevealText: "Tampilkan teks",
    pronHideTextBtn: "Sembunyikan teks",
    pronListenFirst: "Ketuk Dengarkan, lalu coba ulangi.",
    pronRecordPrompt: "Sekarang ucapkan dengan lantang",
    pronCorrect: "Benar! 🎉",
    pronYourAttempt: "Anda mengucapkan:",
    pronTargetLabel: "Target:",
    pronTryAgain: "Coba lagi",
    pronAddNewLabel: "Tambahkan kata atau kalimat",
    pronAddNewPlaceholder: "Ketik atau tempel kata atau kalimat bahasa Jepang...",
    pronAddBtn: "Tambah kata/kalimat",
    pronBreakBtn: "🔍 Pecah menjadi frasa",
    pronBreaking: "Memecah...",
    pronBreakFailed: "Tidak dapat memecah. Coba lagi.",
    speed08: "🐢 0,8x",
    speed05: "🐌 0,5x",
    ...
    freePlanGakuStudentHint: "Siswa yang mengikuti kelas GAKU mendapatkan aplikasi ini gratis. Tidak punya kode? Pesan kelas untuk menjadi siswa GAKU →",
    ...
    wantToJoinGaku: "Ingin bergabung dengan GAKU?",
    checkLater: "Periksa lagi nanti",
    studyPlanReadyTitle: "Rencana belajar Anda sudah siap!",
    studyPlanReadyDesc: "Buka jadwal mingguan pribadi, set latihan, dan alat kosakata Anda.",
    appOnlyLabel: "📱 HANYA APLIKASI",
    monthlyLabel: "BULANAN",
    perMonth: "/ bulan",
    threeMonthsSave5: "3 BULAN · Hemat 5%",
    sixMonthsSave10: "6 BULAN · Hemat 10% ⭐",
    appLessonsLabel: "🎓 APLIKASI + LES · Diskon 50% untuk les",
    threeMonthsSave5_30min: "3 BULAN · Hemat 5% · 30menit/bulan",
    threeMonthsSave5_1hr: "3 BULAN · Hemat 5% · 1jam/bulan",
    sixMonthsSave5_30min: "6 BULAN · Hemat 5% · 30menit/bulan ⭐",
    sixMonthsSave10_1hr: "6 BULAN · Hemat 10% · 1jam/bulan ⭐ Paling Hemat",
    loginTitle: "Masuk",
    signupTitle: "Buat Akun Anda",
    passwordPlaceholder: "Kata sandi",
    invitationCodeOptional: "Kode undangan GAKU (opsional)",
    loginButton: "Masuk",
    signupButton: "Daftar",
    needAccount: "Belum punya akun? Daftar",
    haveAccount: "Sudah punya akun? Masuk",
    deviceApprovalTitle: "Perangkat Baru Terdeteksi",
    deviceApprovalDesc: "Kami telah mengirim email persetujuan kepada Anda dan GAKU. Setelah keduanya menyetujui, perangkat ini akan dibuka kuncinya — silakan periksa kotak masuk Anda.",
    convOrDivider: "ATAU",
    convDescLive: "Putar video YouTube dengan suara di dekat mikrofon Anda. GAKU mendengarkan dialog nyata dan, baris demi baris, membantu Anda memahaminya serta memberi petunjuk cara menanggapinya.",
    convHeardTitle: "Apa yang GAKU dengar",
    convClearBtn: "🗑 Hapus",
    convHintBtn: "Bagaimana Anda akan menanggapi? (4 pilihan)",
    convHintLoading: "Sedang memikirkan petunjuk jawaban...",
    convTryAgain: "↺ Coba lagi",
    convListenTitle: "Dengarkan bersama video",
    convListenDesc: "Putar video YouTube dengan suara di dekat mikrofon Anda. GAKU akan mendengarkan dan membuat transkrip di atas untuk Anda — lalu ketuk \"Buat Latihan Percakapan\" seperti biasa.",
    convListenStart: "Mulai mendengarkan",
    convListenStop: "Berhenti mendengarkan",
    convListening: "Mendengarkan…",
    convListenUnsupported: "Mendengarkan langsung tidak didukung di browser ini — coba Chrome di desktop atau Android.",
    saveWord: "Simpan Kata",
    saveTitle: "Simpan",
    saveToYourVocab: "Tambahkan ke Kosakata Anda",
    saveToYourVocabSub: "Daftar kosakata default Anda",
    saveAddToFolder: "Tambahkan ke Folder",
    saveAddToFolderSub: "Pilih folder yang sudah ada",
    saveCreateFolder: "Buat Folder Baru",
    saveCreateFolderSub: "Buat folder baru untuk kata ini",
    saveCancel: "Batal",
    saveChooseFolder: "Pilih folder",
    saveNoFolders: "Belum ada folder khusus — buat satu dulu!",
    saveTo: "Simpan ke",
    saveCreateAndSave: "Buat & Simpan",
    saveFolderPlaceholder: "Nama folder (misalnya かおりさん 授業)",
    saveBack: "← Kembali",
},
  ...
  "Vietnamese": {
    ...
    tutorialScheduleDesc: "Đây là kế hoạch học tập hàng tuần được cá nhân hóa cho bạn. Hãy thử đánh dấu hoàn thành một nhiệm vụ bên dưới — rồi xem thanh tiến trình đầy dần.",
    tutorialVocabularyDesc: "Thử ngay bây giờ: tìm một từ (ví dụ 食べる) và lưu vào bộ thẻ của riêng bạn. Bạn có thể ôn tập các từ đã lưu bất cứ lúc nào bằng thẻ ghi nhớ.",
    ...
    feedbackChecking: "Đang kiểm tra...",
    feedbackAlreadySubmitted: "Bạn đã gửi phản hồi một lần duy nhất của mình. Cảm ơn bạn! (Học viên được GAKU mời có thể gửi bao nhiêu lần tùy thích.)",
    feedbackSuccess: "Cảm ơn — phản hồi của bạn đã được gửi.",
    feedbackPlaceholder: "Bạn muốn chúng tôi cải thiện điều gì, hoặc bạn đang nghĩ gì?",
    feedbackRejected: "Tin nhắn này không thể được chấp nhận. Vui lòng viết lại mà không có lời lăng mạ cá nhân, quấy rối hoặc ngôn từ phân biệt đối xử.",
    feedbackError: "Đã xảy ra lỗi khi gửi phản hồi của bạn. Vui lòng thử lại.",
    ...
    jlptFormTitle: "Báo cáo Đánh giá JLPT Miễn phí — ĐĂNG KÝ NGAY",
    jlptQuestionLevel: "Bạn muốn thi cấp độ JLPT nào?",
    jlptQuestionMode: "Bạn muốn thi theo hình thức nào?",
    jlptModeSelf: "Tự làm",
    jlptModeTrial: "Làm trong buổi học thử miễn phí",
    jlptQuestionSection: "Bạn muốn làm phần nào của JLPT?",
    jlptSectionLanguage: "Kiến thức ngôn ngữ (Từ vựng/Ngữ pháp)",
    jlptSectionReading: "Đọc hiểu",
    jlptSectionListening: "Nghe hiểu",
    jlptSectionAll: "Tất cả",
    jlptSubmit: "Gửi",
    ...
    pronGenerateBtn: "Tạo bài luyện phát âm",
    pronNoItems: "Không tìm thấy câu có độ dài phù hợp trong nội dung đó. Hãy thử dán thêm văn bản.",
    pronReadMode: "👀 Đọc",
    pronListenMode: "👂 Nghe",
    pronRevealText: "Hiện văn bản",
    pronHideTextBtn: "Ẩn văn bản",
    pronListenFirst: "Nhấn Nghe, sau đó thử lặp lại.",
    pronRecordPrompt: "Bây giờ hãy nói to lên",
    pronCorrect: "Chính xác! 🎉",
    pronYourAttempt: "Bạn đã nói:",
    pronTargetLabel: "Mục tiêu:",
    pronTryAgain: "Thử lại",
    pronAddNewLabel: "Thêm một từ hoặc câu",
    pronAddNewPlaceholder: "Nhập hoặc dán một từ hoặc câu tiếng Nhật...",
    pronAddBtn: "Thêm từ/câu",
    pronBreakBtn: "🔍 Tách thành cụm từ",
    pronBreaking: "Đang tách...",
    pronBreakFailed: "Không thể tách. Hãy thử lại.",
    speed08: "🐢 Tốc độ 0,8x",
    speed05: "🐌 Tốc độ 0,5x",
    translateBtn: "Dịch",
    ...
    freePlanGakuStudentHint: "Học viên học các buổi GAKU được sử dụng ứng dụng miễn phí. Chưa có mã? Đặt một buổi học để trở thành học viên GAKU →",
    ...
    wantToJoinGaku: "Bạn muốn tham gia GAKU?",
    checkLater: "Kiểm tra lại sau",
    studyPlanReadyTitle: "Kế hoạch học tập của bạn đã sẵn sàng!",
    studyPlanReadyDesc: "Mở khóa lịch trình hàng tuần, bộ bài tập và công cụ từ vựng được cá nhân hóa của bạn.",
    appOnlyLabel: "📱 CHỈ ỨNG DỤNG",
    monthlyLabel: "HÀNG THÁNG",
    perMonth: "/ tháng",
    threeMonthsSave5: "3 THÁNG · Tiết kiệm 5%",
    sixMonthsSave10: "6 THÁNG · Tiết kiệm 10% ⭐",
    appLessonsLabel: "🎓 ỨNG DỤNG + BÀI HỌC · Giảm 50% học phí",
    threeMonthsSave5_30min: "3 THÁNG · Tiết kiệm 5% · 30 phút/tháng",
    threeMonthsSave5_1hr: "3 THÁNG · Tiết kiệm 5% · 1 giờ/tháng",
    sixMonthsSave5_30min: "6 THÁNG · Tiết kiệm 5% · 30 phút/tháng ⭐",
    sixMonthsSave10_1hr: "6 THÁNG · Tiết kiệm 10% · 1 giờ/tháng ⭐ Giá trị tốt nhất",
    loginTitle: "Đăng nhập",
    signupTitle: "Tạo tài khoản của bạn",
    passwordPlaceholder: "Mật khẩu",
    invitationCodeOptional: "Mã mời GAKU (không bắt buộc)",
    loginButton: "Đăng nhập",
    signupButton: "Đăng ký",
    needAccount: "Cần tài khoản? Đăng ký",
    haveAccount: "Đã có tài khoản? Đăng nhập",
    deviceApprovalTitle: "Phát hiện thiết bị mới",
    deviceApprovalDesc: "Chúng tôi đã gửi email phê duyệt cho bạn và GAKU. Khi cả hai bên đều phê duyệt, thiết bị này sẽ được mở khóa — vui lòng kiểm tra hộp thư đến của bạn.",
    convOrDivider: "HOẶC",
    convDescLive: "Phát video YouTube có bật âm thanh gần micro của bạn. GAKU lắng nghe đoạn hội thoại thực tế và, từng dòng một, giúp bạn hiểu cũng như gợi ý cách bạn có thể trả lời.",
    convHeardTitle: "Những gì GAKU đã nghe được",
    convClearBtn: "🗑 Xóa",
    convHintBtn: "Bạn sẽ trả lời thế nào? (4 lựa chọn)",
    convHintLoading: "Đang nghĩ gợi ý trả lời...",
    convTryAgain: "↺ Thử lại",
    convListenTitle: "Nghe cùng video",
    convListenDesc: "Phát video YouTube có bật âm thanh gần micro của bạn. GAKU sẽ lắng nghe và tạo bản ghi ở trên cho bạn — sau đó nhấn \"Tạo bài luyện hội thoại\" như bình thường.",
    convListenStart: "Bắt đầu nghe",
    convListenStop: "Dừng nghe",
    convListening: "Đang nghe…",
    convListenUnsupported: "Trình duyệt này không hỗ trợ nghe trực tiếp — hãy thử Chrome trên máy tính hoặc Android.",
    saveWord: "Lưu từ",
    saveTitle: "Lưu",
    saveToYourVocab: "Thêm vào Từ vựng của bạn",
    saveToYourVocabSub: "Danh sách từ vựng mặc định của bạn",
    saveAddToFolder: "Thêm vào Thư mục",
    saveAddToFolderSub: "Chọn một thư mục có sẵn",
    saveCreateFolder: "Tạo Thư mục mới",
    saveCreateFolderSub: "Tạo thư mục mới cho từ này",
    saveCancel: "Hủy",
    saveChooseFolder: "Chọn một thư mục",
    saveNoFolders: "Chưa có thư mục tùy chỉnh nào — hãy tạo một cái trước!",
    saveTo: "Lưu vào",
    saveCreateAndSave: "Tạo & Lưu",
    saveFolderPlaceholder: "Tên thư mục (vd. かおりさん 授業)",
    saveBack: "← Quay lại",
},
  ...
  "Hindi": {
    ...
    tutorialScheduleDesc: "यह आपकी व्यक्तिगत साप्ताहिक अध्ययन योजना है। नीचे किसी एक कार्य को चेक करके देखें — फिर अपनी प्रगति पट्टी को भरते हुए देखें।",
    tutorialVocabularyDesc: "अभी आज़माएं: कोई शब्द खोजें (जैसे 食べる) और उसे अपने खुद के डेक में सेव करें। सेव किए गए शब्दों को आप कभी भी फ्लैशकार्ड से रिवीजन कर सकते हैं।",
    ...
    feedbackChecking: "जाँच हो रही है...",
    feedbackAlreadySubmitted: "आप पहले ही अपनी एक बार की प्रतिक्रिया भेज चुके हैं। धन्यवाद! (GAKU द्वारा आमंत्रित छात्र जितनी बार चाहें भेज सकते हैं।)",
    feedbackSuccess: "धन्यवाद — आपकी प्रतिक्रिया भेज दी गई है।",
    feedbackPlaceholder: "आप क्या सुधार चाहते हैं, या आपके मन में क्या है?",
    feedbackRejected: "यह संदेश स्वीकार नहीं किया जा सका। कृपया व्यक्तिगत अपमान, उत्पीड़न या भेदभावपूर्ण भाषा के बिना इसे फिर से लिखें।",
    feedbackError: "आपकी प्रतिक्रिया भेजने में कुछ गलत हुआ। कृपया पुनः प्रयास करें।",
    ...
    jlptFormTitle: "JLPT निःशुल्क मूल्यांकन रिपोर्ट — अभी आवेदन करें",
    jlptQuestionLevel: "आप कौन सा JLPT स्तर देना चाहते हैं?",
    jlptQuestionMode: "आप इसे कैसे देना पसंद करेंगे?",
    jlptModeSelf: "स्वयं",
    jlptModeTrial: "निःशुल्क ट्रायल लेसन के हिस्से के रूप में",
    jlptQuestionSection: "आप JLPT का कौन सा भाग करना चाहते हैं?",
    jlptSectionLanguage: "भाषा ज्ञान (शब्दावली/व्याकरण)",
    jlptSectionReading: "पठन",
    jlptSectionListening: "श्रवण",
    jlptSectionAll: "सभी",
    jlptSubmit: "सबमिट करें",
    ...
    pronGenerateBtn: "उच्चारण अभ्यास बनाएं",
    pronNoItems: "उस सामग्री में अभ्यास के लिए उपयुक्त लंबाई के वाक्य नहीं मिले। अधिक टेक्स्ट पेस्ट करने का प्रयास करें।",
    pronReadMode: "👀 पढ़ें",
    pronListenMode: "👂 सुनें",
    pronRevealText: "टेक्स्ट दिखाएं",
    pronHideTextBtn: "टेक्स्ट छुपाएं",
    pronListenFirst: "सुनें पर टैप करें, फिर दोहराने की कोशिश करें।",
    pronRecordPrompt: "अब इसे ज़ोर से बोलें",
    pronCorrect: "सही! 🎉",
    pronYourAttempt: "आपने कहा:",
    pronTargetLabel: "लक्ष्य:",
    pronTryAgain: "फिर से कोशिश करें",
    pronAddNewLabel: "एक शब्द या वाक्य जोड़ें",
    pronAddNewPlaceholder: "एक जापानी शब्द या वाक्य टाइप करें या पेस्ट करें...",
    pronAddBtn: "शब्द/वाक्य जोड़ें",
    pronBreakBtn: "🔍 वाक्यांश में विभाजित करें",
    pronBreaking: "विभाजित किया जा रहा है...",
    pronBreakFailed: "विभाजित नहीं किया जा सका। फिर से कोशिश करें।",
    speed08: "🐢 0.8x गति",
    speed05: "🐌 0.5x गति",
    ...
    freePlanGakuStudentHint: "GAKU लेसन लेने वाले छात्रों को ऐप मुफ़्त मिलता है। कोड नहीं है? GAKU छात्र बनने के लिए लेसन बुक करें →",
    ...
    wantToJoinGaku: "GAKU से जुड़ना चाहते हैं?",
    checkLater: "बाद में फिर से जांचें",
    studyPlanReadyTitle: "आपकी स्टडी प्लान तैयार है!",
    studyPlanReadyDesc: "अपना व्यक्तिगत साप्ताहिक कार्यक्रम, अभ्यास सेट और शब्दावली उपकरण अनलॉक करें।",
    appOnlyLabel: "📱 केवल ऐप",
    monthlyLabel: "मासिक",
    perMonth: "/ महीना",
    threeMonthsSave5: "3 महीने · 5% बचाएं",
    sixMonthsSave10: "6 महीने · 10% बचाएं ⭐",
    appLessonsLabel: "🎓 ऐप + क्लासेस · क्लासेस पर 50% छूट",
    threeMonthsSave5_30min: "3 महीने · 5% बचाएं · 30मिनट/महीना",
    threeMonthsSave5_1hr: "3 महीने · 5% बचाएं · 1घंटा/महीना",
    sixMonthsSave5_30min: "6 महीने · 5% बचाएं · 30मिनट/महीना ⭐",
    sixMonthsSave10_1hr: "6 महीने · 10% बचाएं · 1घंटा/महीना ⭐ सबसे बढ़िया",
    loginTitle: "लॉग इन करें",
    signupTitle: "अपना खाता बनाएं",
    passwordPlaceholder: "पासवर्ड",
    invitationCodeOptional: "GAKU आमंत्रण कोड (वैकल्पिक)",
    loginButton: "लॉग इन करें",
    signupButton: "साइन अप करें",
    needAccount: "खाता चाहिए? साइन अप करें",
    haveAccount: "पहले से खाता है? लॉग इन करें",
    deviceApprovalTitle: "नया डिवाइस मिला",
    deviceApprovalDesc: "हमने आपको और GAKU को अनुमोदन ईमेल भेजा है। दोनों की स्वीकृति मिलने पर यह डिवाइस अनलॉक हो जाएगा — कृपया अपना इनबॉक्स जांचें।",
    convOrDivider: "या",
    convDescLive: "अपने माइक के पास आवाज़ चालू रखकर कोई YouTube वीडियो चलाएं। GAKU असली बातचीत सुनता है और, पंक्ति दर पंक्ति, आपको समझने में मदद करता है और बताता है कि आप कैसे जवाब दे सकते हैं।",
    convHeardTitle: "GAKU ने जो सुना",
    convClearBtn: "🗑 साफ़ करें",
    convHintBtn: "आप कैसे जवाब देंगे? (4 विकल्प)",
    convHintLoading: "जवाब के संकेत सोचे जा रहे हैं...",
    convTryAgain: "↺ फिर कोशिश करें",
    convListenTitle: "वीडियो के साथ सुनें",
    convListenDesc: "अपने माइक के पास आवाज़ चालू रखकर कोई YouTube वीडियो चलाएं। GAKU सुनेगा और ऊपर आपके लिए ट्रांसक्रिप्ट बनाएगा — फिर हमेशा की तरह \"बातचीत अभ्यास बनाएं\" पर टैप करें।",
    convListenStart: "सुनना शुरू करें",
    convListenStop: "सुनना बंद करें",
    convListening: "सुन रहा है…",
    convListenUnsupported: "इस ब्राउज़र में लाइव सुनना समर्थित नहीं है — डेस्कटॉप या Android पर Chrome आज़माएं।",
    saveWord: "शब्द सहेजें",
    saveTitle: "सहेजें",
    saveToYourVocab: "अपनी शब्दावली में जोड़ें",
    saveToYourVocabSub: "आपकी डिफ़ॉल्ट शब्दावली सूची",
    saveAddToFolder: "फ़ोल्डर में जोड़ें",
    saveAddToFolderSub: "एक मौजूदा फ़ोल्डर चुनें",
    saveCreateFolder: "नया फ़ोल्डर बनाएं",
    saveCreateFolderSub: "इस शब्द के लिए एक नया फ़ोल्डर बनाएं",
    saveCancel: "रद्द करें",
    saveChooseFolder: "एक फ़ोल्डर चुनें",
    saveNoFolders: "अभी तक कोई कस्टम फ़ोल्डर नहीं — पहले एक बनाएं!",
    saveTo: "यहां सहेजें",
    saveCreateAndSave: "बनाएं और सहेजें",
    saveFolderPlaceholder: "फ़ोल्डर का नाम (उदा. かおりさん 授業)",
    saveBack: "← वापस",
},
  ...
  "Japanese": {
    ...
    tutorialNextBtn: "次へ →",
    tutorialScheduleDesc: "これはあなた専用の週間学習プランです。下のタスクを1つチェックしてみましょう — 進捗バーが伸びていくのが見られます。",
    tutorialVocabularyDesc: "早速試してみましょう: 単語を1つ検索して(例: 食べる)自分の単語帳に保存してみましょう。保存した単語はフラッシュカードでいつでも復習できます。",
    ...
    feedbackChecking: "確認中...",
    feedbackAlreadySubmitted: "フィードバックはすでに1回送信済みです。ありがとうございました！(GAKU招待生徒は何回でも送信できます。)",
    feedbackSuccess: "ありがとうございました — フィードバックを送信しました。",
    feedbackPlaceholder: "改善してほしい点や気になっていることを教えてください",
    feedbackRejected: "このメッセージは受け付けられませんでした。個人への誹謗中傷・嫌がらせ・差別的な表現を含めずに書き直してください。",
    feedbackError: "フィードバックの送信中に問題が発生しました。もう一度お試しください。",
    ...
    jlptFormTitle: "JLPT無料アセスメントレポート — 今すぐ応募",
    jlptQuestionLevel: "どのJLPTレベルを受けたいですか？",
    jlptQuestionMode: "どのように受けたいですか？",
    jlptModeSelf: "自分で",
    jlptModeTrial: "無料体験レッスンの中で受ける",
    jlptQuestionSection: "JLPTのどの部分をやりたいですか？",
    jlptSectionLanguage: "言語知識（語彙・文法）",
    jlptSectionReading: "読解",
    jlptSectionListening: "聴解",
    jlptSectionAll: "すべて",
    jlptSubmit: "送信",
    jlptSubmitting: "送信中…",
    jlptBack: "戻る",
    ...
    pronGenerateBtn: "発音練習を作成",
    pronNoItems: "その内容から練習に適した長さの文が見つかりませんでした。もっとテキストを貼り付けてみてください。",
    pronReadMode: "👀 読む",
    pronListenMode: "👂 聞く",
    pronRevealText: "テキストを表示",
    pronHideTextBtn: "テキストを隠す",
    pronListenFirst: "「聞く」をタップしてから、繰り返して言ってみましょう。",
    pronRecordPrompt: "声に出して言ってみましょう",
    pronCorrect: "正解です!🎉",
    pronYourAttempt: "あなたが言った内容:",
    pronTargetLabel: "正解:",
    pronTryAgain: "もう一度挑戦",
    pronAddNewLabel: "単語・文章を追加",
    pronAddNewPlaceholder: "日本語の単語や文章を入力・貼り付けしてください...",
    pronAddBtn: "単語・文章を追加",
    pronBreakBtn: "🔍 フレーズに分解",
    pronBreaking: "分解中...",
    pronBreakFailed: "分解できませんでした。もう一度お試しください。",
    speed08: "🐢 0.8倍速",
    speed05: "🐌 0.5倍速",
    translateBtn: "翻訳",
    ...
    freePlanGakuStudentHint: "GAKUのレッスンを受けている生徒はアプリが無料で使えます。招待コードをお持ちでない方は、レッスンを予約してGAKU生になりましょう →",
    invitationCodeLabel: "招待コード",
    inviteCodePlaceholder: "招待コードを入力...",
    confirmCode: "確認",
    invalidCode: "コードが無効です。もう一度お試しください。",
    wantToJoinGaku: "GAKUに参加しますか？",
    checkLater: "後でもう一度確認",
    studyPlanReadyTitle: "学習プランの準備ができました！",
    studyPlanReadyDesc: "あなた専用の週間スケジュール、練習セット、単語ツールのロックを解除しましょう。",
    appOnlyLabel: "📱 アプリのみ",
    monthlyLabel: "月払い",
    perMonth: "/ 月",
    threeMonthsSave5: "3ヶ月 · 5%お得",
    sixMonthsSave10: "6ヶ月 · 10%お得 ⭐",
    appLessonsLabel: "🎓 アプリ+レッスン · レッスン50%オフ",
    threeMonthsSave5_30min: "3ヶ月 · 5%お得 · 月30分",
    threeMonthsSave5_1hr: "3ヶ月 · 5%お得 · 月1時間",
    sixMonthsSave5_30min: "6ヶ月 · 5%お得 · 月30分 ⭐",
    sixMonthsSave10_1hr: "6ヶ月 · 10%お得 · 月1時間 ⭐ 一番お得",
    loginTitle: "ログイン",
    signupTitle: "アカウントを作成",
    passwordPlaceholder: "パスワード",
    invitationCodeOptional: "GAKU招待コード（任意）",
    loginButton: "ログイン",
    signupButton: "登録する",
    needAccount: "アカウントが必要ですか？登録する",
    haveAccount: "すでにアカウントをお持ちですか？ログイン",
    deviceApprovalTitle: "新しいデバイスを検出しました",
    deviceApprovalDesc: "あなたとGAKUに承認メールを送信しました。両方が承認すると、このデバイスのロックが解除されます — 受信トレイをご確認ください。",
    convOrDivider: "または",
    convDescLive: "マイクの近くで音を出してYouTube動画などを再生してください。GAKUが実際の会話を聞き取り、一行ずつ理解をサポートしながら、どう答えればよいかヒントを出します。",
    convHeardTitle: "GAKUが聞き取った内容",
    convClearBtn: "🗑 クリア",
    convHintBtn: "あなたならどう答える？（4択）",
    convHintLoading: "返答のヒントを考えています...",
    convTryAgain: "↺ もう一度試す",
    convListenTitle: "動画と一緒に聞く",
    convListenDesc: "マイクの近くで音を出してYouTube動画などを再生してください。GAKUが聞き取って上に文字起こしを作成します — その後はいつも通り「会話練習を作成」をタップしてください。",
    convListenStart: "聞き取りを開始",
    convListenStop: "聞き取りを停止",
    convListening: "聞き取り中…",
    convListenUnsupported: "このブラウザではライブ聞き取りに対応していません — デスクトップまたはAndroidのChromeをお試しください。",
    saveWord: "単語を保存",
    saveTitle: "保存",
    saveToYourVocab: "あなたの単語帳に追加",
    saveToYourVocabSub: "デフォルトの単語リスト",
    saveAddToFolder: "フォルダに追加",
    saveAddToFolderSub: "既存のフォルダを選択",
    saveCreateFolder: "新しいフォルダを作成",
    saveCreateFolderSub: "この単語用に新しいフォルダを作成",
    saveCancel: "キャンセル",
    saveChooseFolder: "フォルダを選択",
    saveNoFolders: "まだカスタムフォルダがありません — まず作成しましょう！",
    saveTo: "保存先",
    saveCreateAndSave: "作成して保存",
    saveFolderPlaceholder: "フォルダ名（例：かおりさん 授業）",
    saveBack: "← 戻る",
},
  ...
  "Turkish": {
    ...
    tutorialScheduleDesc: "Bu, size özel haftalık çalışma planınız. Aşağıdan bir görevi işaretlemeyi deneyin — sonra ilerleme çubuğunuzun dolduğunu izleyin.",
    tutorialVocabularyDesc: "Hemen deneyin: bir kelime arayın (örneğin 食べる) ve kendi destenize kaydedin. Kaydettiğiniz kelimeleri dilediğiniz zaman kartlarla tekrar edebilirsiniz.",
    ...
    feedbackChecking: "Kontrol ediliyor...",
    feedbackAlreadySubmitted: "Tek seferlik geri bildiriminizi zaten gönderdiniz. Teşekkürler! (GAKU tarafından davet edilen öğrenciler istedikleri kadar gönderebilir.)",
    feedbackSuccess: "Teşekkürler — geri bildiriminiz gönderildi.",
    feedbackPlaceholder: "Neyi iyileştirmemizi istersiniz, ya da aklınızda ne var?",
    feedbackRejected: "Bu mesaj kabul edilemedi. Lütfen kişisel hakaret, taciz veya ayrımcı dil içermeden yeniden yazın.",
    feedbackError: "Geri bildiriminiz gönderilirken bir sorun oluştu. Lütfen tekrar deneyin.",
    ...
    jlptFormTitle: "Ücretsiz JLPT Değerlendirme Raporu — ŞİMDİ BAŞVUR",
    jlptQuestionLevel: "Hangi JLPT seviyesine girmek istiyorsunuz?",
    jlptQuestionMode: "Nasıl girmeyi tercih edersiniz?",
    jlptModeSelf: "Kendi başıma",
    jlptModeTrial: "Ücretsiz deneme dersinin bir parçası olarak",
    jlptQuestionSection: "JLPT'nin hangi bölümünü yapmak istiyorsunuz?",
    jlptSectionLanguage: "Dil bilgisi (Kelime/Dilbilgisi)",
    jlptSectionReading: "Okuma",
    jlptSectionListening: "Dinleme",
    jlptSectionAll: "Hepsi",
    jlptSubmit: "Gönder",
    ...
    pronGenerateBtn: "Telaffuz Alıştırması Oluştur",
    pronNoItems: "Bu içerikte alıştırmaya uygun uzunlukta cümle bulunamadı. Daha fazla metin yapıştırmayı deneyin.",
    pronReadMode: "👀 Oku",
    pronListenMode: "👂 Dinle",
    pronRevealText: "Metni göster",
    pronHideTextBtn: "Metni gizle",
    pronListenFirst: "Dinle'ye dokunun, ardından tekrar etmeyi deneyin.",
    pronRecordPrompt: "Şimdi yüksek sesle söyleyin",
    pronCorrect: "Doğru! 🎉",
    pronYourAttempt: "Söylediğiniz:",
    pronTargetLabel: "Hedef:",
    pronTryAgain: "Tekrar dene",
    pronAddNewLabel: "Bir kelime veya cümle ekle",
    pronAddNewPlaceholder: "Bir Japonca kelime veya cümle yazın ya da yapıştırın...",
    pronAddBtn: "Kelime/cümle ekle",
    pronBreakBtn: "🔍 Cümleyi parçalara ayır",
    pronBreaking: "Parçalara ayrılıyor...",
    pronBreakFailed: "Parçalara ayrılamadı. Tekrar deneyin.",
    speed08: "🐢 0,8x",
    speed05: "🐌 0,5x",
    translateBtn: "Çevir",
    ...
    freePlanGakuStudentHint: "GAKU ders alan öğrenciler uygulamayı ücretsiz kullanır. Kodunuz yok mu? GAKU öğrencisi olmak için bir ders rezervasyonu yapın →",
    invitationCodeLabel: "DAVET KODU",
    inviteCodePlaceholder: "Davet kodunu girin...",
    confirmCode: "Onayla",
    invalidCode: "Geçersiz kod. Lütfen tekrar deneyin.",
    wantToJoinGaku: "GAKU'ya katılmak ister misiniz?",
    checkLater: "Daha sonra tekrar kontrol et",
    studyPlanReadyTitle: "Çalışma planınız hazır!",
    studyPlanReadyDesc: "Kişiselleştirilmiş haftalık programınızın, alıştırma setlerinizin ve kelime araçlarınızın kilidini açın.",
    appOnlyLabel: "📱 YALNIZCA UYGULAMA",
    monthlyLabel: "AYLIK",
    perMonth: "/ ay",
    threeMonthsSave5: "3 AY · %5 Tasarruf",
    sixMonthsSave10: "6 AY · %10 Tasarruf ⭐",
    appLessonsLabel: "🎓 UYGULAMA + DERSLER · Derslerde %50 indirim",
    threeMonthsSave5_30min: "3 AY · %5 Tasarruf · Ayda 30dk",
    threeMonthsSave5_1hr: "3 AY · %5 Tasarruf · Ayda 1sa",
    sixMonthsSave5_30min: "6 AY · %5 Tasarruf · Ayda 30dk ⭐",
    sixMonthsSave10_1hr: "6 AY · %10 Tasarruf · Ayda 1sa ⭐ En İyi Değer",
    loginTitle: "Giriş Yap",
    signupTitle: "Hesabınızı Oluşturun",
    passwordPlaceholder: "Şifre",
    invitationCodeOptional: "GAKU davet kodu (isteğe bağlı)",
    loginButton: "Giriş Yap",
    signupButton: "Kaydol",
    needAccount: "Hesabınız yok mu? Kaydolun",
    haveAccount: "Zaten bir hesabınız mı var? Giriş yapın",
    deviceApprovalTitle: "Yeni Cihaz Algılandı",
    deviceApprovalDesc: "Size ve GAKU'ya bir onay e-postası gönderdik. İkisi de onayladığında bu cihazın kilidi açılacak — lütfen gelen kutunuzu kontrol edin.",
    convOrDivider: "VEYA",
    convDescLive: "Mikrofonunuzun yakınında sesi açık bir YouTube videosu oynatın. GAKU gerçek diyaloğu dinler ve satır satır anlamanıza yardımcı olarak nasıl cevap verebileceğinize dair ipuçları verir.",
    convHeardTitle: "GAKU'nun duyduğu şey",
    convClearBtn: "🗑 Temizle",
    convHintBtn: "Nasıl cevap verirdiniz? (4 seçenek)",
    convHintLoading: "Cevap ipuçları düşünülüyor...",
    convTryAgain: "↺ Tekrar dene",
    convListenTitle: "Bir videoyla birlikte dinle",
    convListenDesc: "Mikrofonunuzun yakınında sesi açık bir YouTube videosu oynatın. GAKU dinleyecek ve yukarıdaki dökümü sizin için oluşturacak — ardından her zamanki gibi \"Konuşma Alıştırması Oluştur\"a dokunun.",
    convListenStart: "Dinlemeye başla",
    convListenStop: "Dinlemeyi durdur",
    convListening: "Dinleniyor…",
    convListenUnsupported: "Canlı dinleme bu tarayıcıda desteklenmiyor — masaüstünde veya Android'de Chrome'u deneyin.",
    saveWord: "Kelimeyi Kaydet",
    saveTitle: "Kaydet",
    saveToYourVocab: "Kelime Dağarcığınıza Ekle",
    saveToYourVocabSub: "Varsayılan kelime listeniz",
    saveAddToFolder: "Klasöre Ekle",
    saveAddToFolderSub: "Mevcut bir klasör seçin",
    saveCreateFolder: "Yeni Klasör Oluştur",
    saveCreateFolderSub: "Bu kelime için yeni bir klasör oluşturun",
    saveCancel: "İptal",
    saveChooseFolder: "Bir klasör seçin",
    saveNoFolders: "Henüz özel klasör yok — önce bir tane oluşturun!",
    saveTo: "Şuraya kaydet",
    saveCreateAndSave: "Oluştur ve Kaydet",
    saveFolderPlaceholder: "Klasör adı (örn. かおりさん 授業)",
    saveBack: "← Geri",
},
  ...
  "Nepali": {
    ...
    tutorialScheduleDesc: "यो तपाईंको व्यक्तिगत साप्ताहिक अध्ययन योजना हो। तल कुनै एक कार्यमा चेक गरेर हेर्नुहोस् — त्यसपछि आफ्नो प्रगति बार भरिँदै जाने हेर्नुहोस्।",
    tutorialVocabularyDesc: "अहिले नै प्रयास गर्नुहोस्: कुनै शब्द खोज्नुहोस् (जस्तै 食べる) र आफ्नै डेकमा सेभ गर्नुहोस्। सेभ गरिएका शब्दहरू तपाईं जहिले पनि फ्ल्यासकार्डको साथ पुनरावलोकन गर्न सक्नुहुन्छ।",
    ...
    feedbackChecking: "जाँच गर्दै...",
    feedbackAlreadySubmitted: "तपाईंले आफ्नो एक पटकको प्रतिक्रिया पहिले नै पठाइसक्नुभएको छ। धन्यवाद! (GAKU ले निमन्त्रणा गरेका विद्यार्थीहरूले जति पटक चाहे पनि पठाउन सक्छन्।)",
    feedbackSuccess: "धन्यवाद — तपाईंको प्रतिक्रिया पठाइयो।",
    feedbackPlaceholder: "तपाईं के सुधार गरियोस् भन्ने चाहनुहुन्छ, वा मनमा के छ?",
    feedbackRejected: "यो सन्देश स्वीकार गर्न सकिएन। कृपया व्यक्तिगत अपमान, दुर्व्यवहार वा भेदभावपूर्ण भाषा नराखी फेरि लेख्नुहोस्।",
    feedbackError: "तपाईंको प्रतिक्रिया पठाउँदा समस्या भयो। कृपया फेरि प्रयास गर्नुहोस्।",
    feedbackSubmitting: "पठाउँदै...",
    feedbackSubmit: "प्रतिक्रिया पठाउनुहोस्",
    tabSubtitles: "🎬 सबटाइटल",
    ...
    jlptFormTitle: "JLPT निःशुल्क मूल्याङ्कन प्रतिवेदन — अहिले आवेदन दिनुहोस्",
    jlptQuestionLevel: "तपाईं कुन JLPT तह दिन चाहनुहुन्छ?",
    jlptQuestionMode: "तपाईं यसलाई कसरी दिन रुचाउनुहुन्छ?",
    jlptModeSelf: "आफैं",
    jlptModeTrial: "निःशुल्क ट्रायल कक्षाको भागको रूपमा",
    jlptQuestionSection: "तपाईं JLPT को कुन भाग गर्न चाहनुहुन्छ?",
    jlptSectionLanguage: "भाषा ज्ञान (शब्दावली/व्याकरण)",
    jlptSectionReading: "पठन",
    jlptSectionListening: "श्रवण",
    jlptSectionAll: "सबै",
    jlptSubmit: "पेश गर्नुहोस्",
    ...
    pronGenerateBtn: "उच्चारण अभ्यास बनाउनुहोस्",
    pronNoItems: "त्यो सामग्रीमा अभ्यासका लागि उपयुक्त लम्बाइका वाक्यहरू फेला परेनन्। थप पाठ टाँस्ने प्रयास गर्नुहोस्।",
    pronReadMode: "👀 पढ्नुहोस्",
    pronListenMode: "👂 सुन्नुहोस्",
    pronRevealText: "पाठ देखाउनुहोस्",
    pronHideTextBtn: "पाठ लुकाउनुहोस्",
    pronListenFirst: "सुन्नुहोस् थिच्नुहोस्, त्यसपछि दोहोर्याउने प्रयास गर्नुहोस्।",
    pronRecordPrompt: "अब ठूलो स्वरमा भन्नुहोस्",
    pronCorrect: "सही! 🎉",
    pronYourAttempt: "तपाईंले भन्नुभयो:",
    pronTargetLabel: "लक्ष्य:",
    pronTryAgain: "फेरि प्रयास गर्नुहोस्",
    pronAddNewLabel: "शब्द वा वाक्य थप्नुहोस्",
    pronAddNewPlaceholder: "जापानी शब्द वा वाक्य टाइप गर्नुहोस् वा टाँस्नुहोस्...",
    pronAddBtn: "शब्द/वाक्य थप्नुहोस्",
    pronBreakBtn: "🔍 वाक्यांशमा विभाजन गर्नुहोस्",
    pronBreaking: "विभाजन गर्दै...",
    pronBreakFailed: "विभाजन गर्न सकिएन। फेरि प्रयास गर्नुहोस्।",
    speed08: "🐢 0.8x गति",
    speed05: "🐌 0.5x गति",
    ...
    freePlanGakuStudentHint: "GAKU कक्षा लिने विद्यार्थीहरूले एप निःशुल्क पाउँछन्। कोड छैन? GAKU विद्यार्थी बन्न कक्षा बुक गर्नुहोस् →",
    invitationCodeLabel: "आमन्त्रण कोड",
    inviteCodePlaceholder: "आमन्त्रण कोड प्रविष्ट गर्नुहोस्...",
    confirmCode: "पुष्टि गर्नुहोस्",
    invalidCode: "अमान्य कोड। कृपया फेरि प्रयास गर्नुहोस्।",
    wantToJoinGaku: "GAKU मा सामेल हुन चाहनुहुन्छ?",
    checkLater: "पछि फेरि जाँच गर्नुहोस्",
    studyPlanReadyTitle: "तपाईंको अध्ययन योजना तयार छ!",
    studyPlanReadyDesc: "आफ्नो व्यक्तिगत साप्ताहिक तालिका, अभ्यास सेटहरू, र शब्दावली उपकरणहरू अनलक गर्नुहोस्।",
    appOnlyLabel: "📱 एप मात्र",
    monthlyLabel: "मासिक",
    perMonth: "/ महिना",
    threeMonthsSave5: "3 महिना · 5% बचत",
    sixMonthsSave10: "6 महिना · 10% बचत ⭐",
    appLessonsLabel: "🎓 एप + कक्षाहरू · कक्षामा 50% छुट",
    threeMonthsSave5_30min: "3 महिना · 5% बचत · महिनाको 30मिनेट",
    threeMonthsSave5_1hr: "3 महिना · 5% बचत · महिनाको 1घण्टा",
    sixMonthsSave5_30min: "6 महिना · 5% बचत · महिनाको 30मिनेट ⭐",
    sixMonthsSave10_1hr: "6 महिना · 10% बचत · महिनाको 1घण्टा ⭐ उत्तम मूल्य",
    loginTitle: "लग इन गर्नुहोस्",
    signupTitle: "आफ्नो खाता बनाउनुहोस्",
    passwordPlaceholder: "पासवर्ड",
    invitationCodeOptional: "GAKU आमन्त्रण कोड (वैकल्पिक)",
    loginButton: "लग इन गर्नुहोस्",
    signupButton: "साइन अप गर्नुहोस्",
    needAccount: "खाता चाहियो? साइन अप गर्नुहोस्",
    haveAccount: "पहिले नै खाता छ? लग इन गर्नुहोस्",
    deviceApprovalTitle: "नयाँ डिभाइस फेला पर्यो",
    deviceApprovalDesc: "हामीले तपाईं र GAKU लाई स्वीकृति इमेल पठाएका छौं। दुवैले स्वीकृति दिएपछि, यो डिभाइस अनलक हुनेछ — कृपया आफ्नो इनबक्स जाँच गर्नुहोस्।",
    convOrDivider: "वा",
    convDescLive: "आफ्नो माइकको नजिक आवाज खुला राखी YouTube भिडियो बजाउनुहोस्। GAKU ले वास्तविक कुराकानी सुन्छ र, लाइन-लाइन गरी, तपाईंलाई बुझ्न मद्दत गर्छ र कसरी जवाफ दिने भन्ने संकेत दिन्छ।",
    convHeardTitle: "GAKU ले के सुन्यो",
    convClearBtn: "🗑 खाली गर्नुहोस्",
    convHintBtn: "तपाईं कसरी जवाफ दिनुहुन्छ? (4 विकल्प)",
    convHintLoading: "जवाफका संकेतहरू सोचिँदैछ...",
    convTryAgain: "↺ फेरि प्रयास गर्नुहोस्",
    convListenTitle: "भिडियोसँगै सुन्नुहोस्",
    convListenDesc: "आफ्नो माइकको नजिक आवाज खुला राखी YouTube भिडियो बजाउनुहोस्। GAKU ले सुन्नेछ र माथि तपाईंको लागि ट्रान्सक्रिप्ट बनाउनेछ — त्यसपछि सधैंझैं \"कुराकानी अभ्यास बनाउनुहोस्\" थिच्नुहोस्।",
    convListenStart: "सुन्न सुरु गर्नुहोस्",
    convListenStop: "सुन्न रोक्नुहोस्",
    convListening: "सुनिँदैछ…",
    convListenUnsupported: "यो ब्राउजरमा लाइभ सुन्ने सुविधा उपलब्ध छैन — डेस्कटप वा Android मा Chrome प्रयास गर्नुहोस्।",
    saveWord: "शब्द बचत गर्नुहोस्",
    saveTitle: "बचत गर्नुहोस्",
    saveToYourVocab: "तपाईंको शब्दावलीमा थप्नुहोस्",
    saveToYourVocabSub: "तपाईंको पूर्वनिर्धारित शब्दावली सूची",
    saveAddToFolder: "फोल्डरमा थप्नुहोस्",
    saveAddToFolderSub: "अवस्थित फोल्डर छान्नुहोस्",
    saveCreateFolder: "नयाँ फोल्डर बनाउनुहोस्",
    saveCreateFolderSub: "यो शब्दका लागि नयाँ फोल्डर बनाउनुहोस्",
    saveCancel: "रद्द गर्नुहोस्",
    saveChooseFolder: "फोल्डर छान्नुहोस्",
    saveNoFolders: "अझै कुनै कस्टम फोल्डर छैन — पहिले एउटा बनाउनुहोस्!",
    saveTo: "यसमा बचत गर्नुहोस्",
    saveCreateAndSave: "बनाउनुहोस् र बचत गर्नुहोस्",
    saveFolderPlaceholder: "फोल्डरको नाम (जस्तै かおりさん 授業)",
    saveBack: "← फिर्ता",
},
  ...
  "Filipino": {
    ...
    tutorialScheduleDesc: "Ito ang iyong personalized na lingguhang study plan. Subukang i-check ang isang gawain sa ibaba — pagkatapos ay panoorin ang iyong progress bar habang tumataas.",
    tutorialVocabularyDesc: "Subukan na ngayon: maghanap ng isang salita (hal. 食べる) at i-save ito sa sarili mong deck. Puwede mong balikan ang mga naka-save na salita anumang oras gamit ang flashcards.",
    ...
    feedbackChecking: "Sinusuri...",
    feedbackAlreadySubmitted: "Naisumite mo na ang iyong isang beses na puna. Salamat! (Ang mga estudyanteng inimbitahan ng GAKU ay maaaring magsumite nang paulit-ulit.)",
    feedbackSuccess: "Salamat — naipadala na ang iyong puna.",
    feedbackPlaceholder: "Ano ang gusto mong pagbutihin namin, o ano ang nasa isip mo?",
    feedbackRejected: "Hindi natanggap ang mensaheng ito. Mangyaring i-rephrase nang walang personal na insulto, panliligalig, o diskriminasyong wika.",
    feedbackError: "May naganap na problema sa pagpapadala ng iyong puna. Pakisubukang muli.",
    feedbackSubmitting: "Ipinapadala...",
    feedbackSubmit: "Isumite ang Puna",
    tabSubtitles: "🎬 Subtitle",
    ...
    jlptFormTitle: "Libreng JLPT Assessment Report — MAG-APPLY NGAYON",
    jlptQuestionLevel: "Aling antas ng JLPT ang gusto mong kunin?",
    jlptQuestionMode: "Paano mo gustong kunin ito?",
    jlptModeSelf: "Mag-isa",
    jlptModeTrial: "Kunin bilang bahagi ng Libreng Trial Lesson",
    jlptQuestionSection: "Aling bahagi ng JLPT ang gusto mong gawin?",
    jlptSectionLanguage: "Kaalaman sa wika (Bokabularyo/Gramatika)",
    jlptSectionReading: "Pagbasa",
    jlptSectionListening: "Pakikinig",
    jlptSectionAll: "Lahat",
    jlptSubmit: "Ipasa",
    ...
    pronGenerateBtn: "Gumawa ng Pagsasanay sa Pagbigkas",
    pronNoItems: "Walang nakitang mga pangungusap na sapat ang haba para sa pagsasanay sa nilalamang iyon. Subukang mag-paste ng mas maraming teksto.",
    pronReadMode: "👀 Basahin",
    pronListenMode: "👂 Pakinggan",
    pronRevealText: "Ipakita ang teksto",
    pronHideTextBtn: "Itago ang teksto",
    pronListenFirst: "I-tap ang Pakinggan, pagkatapos ay subukang ulitin ito.",
    pronRecordPrompt: "Ngayon ay sabihin ito nang malakas",
    pronCorrect: "Tama! 🎉",
    pronYourAttempt: "Sinabi mo:",
    pronTargetLabel: "Target:",
    pronTryAgain: "Subukan ulit",
    pronAddNewLabel: "Magdagdag ng salita o pangungusap",
    pronAddNewPlaceholder: "I-type o i-paste ang isang salita o pangungusap na Hapon...",
    pronAddBtn: "Magdagdag ng salita/pangungusap",
    pronBreakBtn: "🔍 Hatiin ang parirala",
    pronBreaking: "Hinahati...",
    pronBreakFailed: "Hindi mahati. Subukan ulit.",
    speed08: "🐢 0.8x",
    speed05: "🐌 0.5x",
    translateBtn: "Isalin",
    ...
    freePlanGakuStudentHint: "Ang mga estudyanteng may GAKU lessons ay libreng makakagamit ng app. Walang code? Mag-book ng lesson para maging isa →",
    invitationCodeLabel: "CODE NG PAG-IMBITA",
    inviteCodePlaceholder: "Ilagay ang invite code...",
    confirmCode: "Kumpirmahin",
    invalidCode: "Hindi wastong code. Pakisubukan muli.",
    wantToJoinGaku: "Gusto mo bang sumali sa GAKU?",
    checkLater: "Tingnan ulit mamaya",
    studyPlanReadyTitle: "Handa na ang iyong Study Plan!",
    studyPlanReadyDesc: "I-unlock ang iyong personalized na weekly schedule, mga practice set, at vocabulary tools.",
    appOnlyLabel: "📱 APP LANG",
    monthlyLabel: "BUWANAN",
    perMonth: "/ buwan",
    threeMonthsSave5: "3 BUWAN · Makatipid ng 5%",
    sixMonthsSave10: "6 BUWAN · Makatipid ng 10% ⭐",
    appLessonsLabel: "🎓 APP + MGA LESSON · 50% diskwento sa lessons",
    threeMonthsSave5_30min: "3 BUWAN · Makatipid ng 5% · 30min/buwan",
    threeMonthsSave5_1hr: "3 BUWAN · Makatipid ng 5% · 1oras/buwan",
    sixMonthsSave5_30min: "6 BUWAN · Makatipid ng 5% · 30min/buwan ⭐",
    sixMonthsSave10_1hr: "6 BUWAN · Makatipid ng 10% · 1oras/buwan ⭐ Pinakamasulit",
    loginTitle: "Mag-log In",
    signupTitle: "Gumawa ng Iyong Account",
    passwordPlaceholder: "Password",
    invitationCodeOptional: "GAKU invite code (opsyonal)",
    loginButton: "Mag-log In",
    signupButton: "Mag-sign Up",
    needAccount: "Kailangan ng account? Mag-sign up",
    haveAccount: "May account ka na ba? Mag-log in",
    deviceApprovalTitle: "May Nakitang Bagong Device",
    deviceApprovalDesc: "Nagpadala kami ng approval email sa iyo at sa GAKU. Kapag pareho nang na-approve, mabubuksan ang device na ito — pakitingnan ang iyong inbox.",
    convOrDivider: "O",
    convDescLive: "Mag-play ng YouTube video na naka-on ang tunog malapit sa iyong mic. Nakikinig ang GAKU sa totoong usapan at, linya por linya, tinutulungan kang maintindihan ito at nagbibigay ng hint kung paano ka sasagot.",
    convHeardTitle: "Ang narinig ng GAKU",
    convClearBtn: "🗑 I-clear",
    convHintBtn: "Paano mo sasagutin? (4 na pagpipilian)",
    convHintLoading: "Nag-iisip ng mga hint sa sagot...",
    convTryAgain: "↺ Subukan ulit",
    convListenTitle: "Makinig kasabay ng video",
    convListenDesc: "Mag-play ng YouTube video na naka-on ang tunog malapit sa iyong mic. Makikinig ang GAKU at gagawa ng transcript sa itaas para sa iyo — pagkatapos ay pindutin ang \"Gumawa ng Conversation Practice\" gaya ng dati.",
    convListenStart: "Simulan ang pakikinig",
    convListenStop: "Ihinto ang pakikinig",
    convListening: "Nakikinig…",
    convListenUnsupported: "Hindi suportado ang live listening sa browser na ito — subukan ang Chrome sa desktop o Android.",
    saveWord: "I-save ang Salita",
    saveTitle: "I-save",
    saveToYourVocab: "Idagdag sa Iyong Vocabulary",
    saveToYourVocabSub: "Ang iyong default na listahan ng vocabulary",
    saveAddToFolder: "Idagdag sa Folder",
    saveAddToFolderSub: "Pumili ng umiiral na folder",
    saveCreateFolder: "Gumawa ng Bagong Folder",
    saveCreateFolderSub: "Gumawa ng bagong folder para sa salitang ito",
    saveCancel: "Kanselahin",
    saveChooseFolder: "Pumili ng folder",
    saveNoFolders: "Wala pang custom na folder — gumawa muna ng isa!",
    saveTo: "I-save sa",
    saveCreateAndSave: "Gumawa & I-save",
    saveFolderPlaceholder: "Pangalan ng folder (hal. かおりさん 授業)",
    saveBack: "← Bumalik",
},
...
const JAPANESE_READING_CORRECTIONS = [
  ...
  // Specific wrong readings the model has produced — force the correct reading.
  [/海(\s*)\(かい\)(?![\u4E00-\u9FFF])/g, "海$1(うみ)"],
  [/厳しい(\s*)\(げんしい\)/g, "厳しい$1(きびしい)"],
  [/応えて(\s*)\(おうえて\)/g, "応えて$1(こたえて)"],
  [/各国(\s*)\((?!かっこく\))[^)]*\)/g, "各国$1(かっこく)"],
  [/一層(\s*)\((?!いっそう\))[^)]*\)/g, "一層$1(いっそう)"],
  [/私(\s*)\(わた\)/g, "私$1(わたし)"],
  [/節水(\s*)\((?!せっすい\))[^)]*\)/g, "節水$1(せっすい)"],
  [/意外(\s*)\((?!いがい\))[^)]*\)/g, "意外$1(いがい)"],
    ...
    <div style={{ ...S.page, paddingBottom:60 }}>
      ...
      <div style={{ maxWidth:600, margin:"0 auto", padding:"20px 16px" }}>
        ...
        {showJlptMockOffer && jlptMockStep === "form" && (
          <div style={{ ...S.card, marginBottom:16, background:"rgba(168,85,247,0.1)", border:`1px solid ${C.purpleLight}` }}>
            <p style={{ color:C.purpleLight, fontSize:12, fontWeight:700, margin:"0 0 12px" }}>🎯 {T.jlptFormTitle}</p>

            <label style={{ ...S.label, fontSize:11 }}>{T.jlptQuestionLevel}</label>
            ...
            <label style={{ ...S.label, fontSize:11 }}>{T.jlptQuestionMode}</label>
            <select value={jlptMockAnswers.mode} onChange={e=>setJlptMockAnswers(a=>({...a, mode:e.target.value}))} style={{ ...S.input, marginBottom:10 }}>
              <option value="self">{T.jlptModeSelf}</option>
              <option value="trial_lesson">{T.jlptModeTrial}</option>
            </select>

            <label style={{ ...S.label, fontSize:11 }}>{T.jlptQuestionSection}</label>
            <select value={jlptMockAnswers.section} onChange={e=>setJlptMockAnswers(a=>({...a, section:e.target.value}))} style={{ ...S.input, marginBottom:12 }}>
              <option value="language_knowledge">{T.jlptSectionLanguage}</option>
              <option value="reading">{T.jlptSectionReading}</option>
              <option value="listening">{T.jlptSectionListening}</option>
              <option value="all">{T.jlptSectionAll}</option>
            </select>
            ...
            <div style={{ display:"flex", gap:8 }}>
              <button onClick={submitJlptMockRequest} disabled={jlptMockSubmitting} style={{ ...S.btn, padding:"7px 14px", fontSize:12, background:`linear-gradient(135deg,${C.purple},#9333ea)`, color:"#fff", opacity:jlptMockSubmitting?0.6:1 }}>
                {jlptMockSubmitting ? T.jlptSubmitting : T.jlptSubmit}
              </button>
        ...
        {jlptMockStep === "done" && (
          <div style={{ ...S.card, marginBottom:16, background:"rgba(34,197,94,0.1)", border:"1px solid #22c55e" }}>
            <p style={{ color:"#4ade80", fontSize:12, margin:0 }}>✅ {T.jlptDoneMessage}</p>
          </div>
        )}
