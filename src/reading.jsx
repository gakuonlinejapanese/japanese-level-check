...
function CTABlock() {
  ...
  return (
    <div style={{marginTop:24,padding:'20px',background:'rgba(255,255,255,0.04)',borderRadius:16,border:'1px solid rgba(255,255,255,0.08)',textAlign:'center'}}>
      ...
      {ctaStep===1&&(<><p style={{color:'#f1f5f9',fontSize:16,fontWeight:700,marginBottom:16}}>Which one do you need?</p><div style={{display:'flex',gap:10,justifyContent:'center',flexWrap:'wrap'}}><button onClick={()=>setCtaStep(2)} style={{padding:'12px 20px',background:'linear-gradient(135deg,#3b82f6,#1d4ed8)',color:'#fff',border:'none',borderRadius:12,fontSize:13,fontWeight:700,cursor:'pointer'}}>Need a FREE Japanese Q&A session</button><button onClick={()=>setCtaStep(5)} style={{padding:'12px 20px',background:'linear-gradient(135deg,#a855f7,#7c3aed)',color:'#fff',border:'none',borderRadius:12,fontSize:13,fontWeight:700,cursor:'pointer'}}>Get a personalized self-study set</button></div></>)}
      ...
      {ctaStep===4&&(<><p style={{color:'#64748b',fontSize:14,marginBottom:12}}>Great! Keep up the good work!</p><button onClick={()=>setCtaStep(5)} style={{padding:'12px 20px',background:'linear-gradient(135deg,#a855f7,#7c3aed)',color:'#fff',border:'none',borderRadius:12,fontSize:13,fontWeight:700,cursor:'pointer'}}>Get a personalized self-study set</button></>)}
      {ctaStep===5&&(<p style={{color:'#94a3b8',fontSize:14,margin:0}}>🚀 Self-study set — Coming soon!</p>)}
    </div>
  );
}
